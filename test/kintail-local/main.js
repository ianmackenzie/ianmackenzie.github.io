	...
	return _elm_lang$core$Json_Encode$object(
		{
			...
			_0: {
				ctor: '_Tuple2',
				_0: 'elementId',
				_1: _elm_lang$core$Json_Encode$string(_p2.elementId)
			},
			_1: {
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: 'index',
					_1: _elm_lang$core$Json_Encode$int(_p2.index)
				},
				_1: {
					ctor: '::',
					_0: {
						...
						_1: {
							...
							_1: {
								...
								_0: {
									ctor: '_Tuple2',
									_0: 'mimeType',
									_1: _elm_lang$core$Json_Encode$string(mimeTypeString)
								},
								_1: {ctor: '[]'}
							}
						}
...
var _kintail$local$Kintail_Local_File$mimeType = function (_p3) {
	var _p4 = _p3;
	return _p4._0.mimeType;
};
var _kintail$local$Kintail_Local_File$lastModified = function (_p5) {
	var _p6 = _p5;
	return _p6._0.lastModified;
};
var _kintail$local$Kintail_Local_File$sizeInBytes = function (_p7) {
	var _p8 = _p7;
	return _p8._0.sizeInBytes;
};
var _kintail$local$Kintail_Local_File$name = function (_p9) {
	var _p10 = _p9;
	return _p10._0.name;
};
var _kintail$local$Kintail_Local_File$File = function (a) {
...
var _kintail$local$Kintail_Local_File$fileDecoder = F2(
	function (id, index) {
		...
		return A5(
			...
			F4(
				function (name, sizeInBytes, lastModified, mimeType) {
					return _kintail$local$Kintail_Local_File$File(
...
var _kintail$local$Kintail_Local_File$accumulateFiles = F3(
	function (id, index, accumulated) {
		return (_elm_lang$core$Native_Utils.cmp(index, 0) > -1) ? A2(
			_elm_lang$core$Json_Decode$andThen,
			function (file) {
				return A3(
					_kintail$local$Kintail_Local_File$accumulateFiles,
					id,
					index - 1,
					{ctor: '::', _0: file, _1: accumulated});
			},
			A2(
				_elm_lang$core$Json_Decode$field,
				_elm_lang$core$Basics$toString(index),
				A2(_kintail$local$Kintail_Local_File$fileDecoder, id, index))) : _elm_lang$core$Json_Decode$succeed(accumulated);
	});
var _kintail$local$Kintail_Local_File$fileListDecoder = function (id) {
	return A2(
		_elm_lang$core$Json_Decode$andThen,
		function (length) {
			return A3(
...
var _kintail$local$Kintail_Local_File$selectedFiles = A2(
	_elm_lang$core$Json_Decode$field,
	'target',
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (id) {
			return A2(
				_elm_lang$core$Json_Decode$field,
				'files',
				_kintail$local$Kintail_Local_File$fileListDecoder(id));
		},
		A2(_elm_lang$core$Json_Decode$field, 'id', _elm_lang$core$Json_Decode$string)));
var _kintail$local$Kintail_Local_File$chooser = F3(
	function (id, tag, additionalAttributes) {
		var onChangeAttribute = A2(
			_elm_lang$html$Html_Events$on,
			'change',
			A2(_elm_lang$core$Json_Decode$map, tag, _kintail$local$Kintail_Local_File$selectedFiles));
		var idAttribute = _elm_lang$html$Html_Attributes$id(id);
		var typeAttribute = _elm_lang$html$Html_Attributes$type_('file');
		var attributes = {
			ctor: '::',
			_0: typeAttribute,
			_1: {
				ctor: '::',
				_0: idAttribute,
				_1: {ctor: '::', _0: onChangeAttribute, _1: additionalAttributes}
			}
		};
		return A2(
...
var _kintail$local$Kintail_Local_File$ReadError = {ctor: 'ReadError'};
var _kintail$local$Kintail_Local_File$read = function (file) {
	...
	var encoded = _elm_lang$core$Json_Encode$object(
		{
			...
			_0: {
				ctor: '_Tuple2',
				_0: 'contents',
				_1: _elm_lang$core$Json_Encode$string(_p12.contents)
			},
			_1: {
				ctor: '::',
				_0: {
					ctor: '_Tuple2',
					_0: 'suggestedFilename',
					_1: _elm_lang$core$Json_Encode$string(_p12.suggestedFilename)
				},
				_1: {ctor: '[]'}
			}
		});
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _kintail$local$Main$main !== 'undefined') {
    _kintail$local$Main$main(Elm['Main'], 'Main', undefined);
}
