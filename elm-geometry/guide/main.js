...
{
	if (region.fT.a9 === region.cZ.a9)
	{
		return 'on line ' + region.fT.a9;
	}
	return 'on lines ' + region.fT.a9 + ' through ' + region.cZ.a9;
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.G, request.aG, true);
		} catch (e) {
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { eR: 'hidden', er: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { eR: 'mozHidden', er: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { eR: 'msHidden', er: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { eR: 'webkitHidden', er: 'webkitvisibilitychange' }
		: { eR: 'hidden', er: 'visibilitychange' };
}
...
function _Browser_getViewport()
{
	return {
		...
		dV: {
			...
			gl: _Browser_window.pageYOffset,
			dW: _Browser_doc.documentElement.clientWidth,
			eP: _Browser_doc.documentElement.clientHeight
		}
	};
}
...
function _Browser_getScene()
{
	...
	return {
		...
		eP: Math.max(body.scrollHeight, body.offsetHeight, elem.scrollHeight, elem.offsetHeight, elem.clientHeight)
	};
}
...
function _Browser_getViewportOf(id)
{
	return _Browser_withNode(id, function(node)
	{
		return {
			dA: {
				dW: node.scrollWidth,
				eP: node.scrollHeight
			},
			dV: {
				bT: node.scrollLeft,
				gl: node.scrollTop,
				dW: node.clientWidth,
				eP: node.clientHeight
			}
		};
	});
}
...
var elm$regex$Regex$Match = F4(
	function (match, index, number, submatches) {
		return {eZ: index, e7: match, fk: number, f$: submatches};
	});
									...
									case 4:
										...
										return prependLink(
											author$project$Guide$Document$Image(
												{
													cX: pablohirafuji$elm_markdown$Markdown$Inline$extractText(imageInlines),
													aG: imageUrl
												}));
									default:
										break _n2$5;
...
var elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {ev: col, ez: contextStack, dq: problem, fE: row};
	});
...
var elm$parser$Parser$Advanced$chompUntil = function (_n0) {
	...
	var expecting = _n0.b;
	return function (s) {
		var _n1 = A5(elm$parser$Parser$Advanced$findSubString, str, s.a, s.fE, s.ev, s.dE);
		var newOffset = _n1.a;
		var newRow = _n1.b;
		var newCol = _n1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			0,
			{ev: newCol, f: s.f, l: s.l, a: newOffset, fE: newRow, dE: s.dE});
	};
};
		...
		return function (s0) {
			...
			if (_n1.$ === 1) {
				...
				return A3(
					...
					A2(
						func,
						A3(elm$core$String$slice, s0.a, s1.a, s0.dE),
						a),
					s1);
			}
		};
...
var elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			elm$parser$Parser$Advanced$AddRight,
			elm$parser$Parser$Advanced$Empty,
			A4(elm$parser$Parser$Advanced$DeadEnd, s.fE, s.ev, x, s.f));
	});
...
var elm$parser$Parser$Advanced$token = function (_n0) {
	...
	return function (s) {
		var _n1 = A5(elm$parser$Parser$Advanced$isSubString, str, s.a, s.fE, s.ev, s.dE);
		var newOffset = _n1.a;
		var newRow = _n1.b;
		var newCol = _n1.c;
		return _Utils_eq(newOffset, -1) ? A2(
...
var author$project$Guide$Syntax$identifierType = function (fullString) {
	...
	var _n0 = A2(elm_community$list_extra$List$Extra$splitWhen, author$project$Guide$Syntax$isNotCapitalized, parts);
	_n0$1:
	while (true) {
		if (_n0.$ === 1) {
			...
			if (!_n0.a.b.b) {
				...
				if (!_n0.a.a.b) {
					...
					var _n3 = _n0.a;
					var moduleParts = _n3.a;
					var _n4 = _n3.b;
					var memberName = _n4.a;
					return author$project$Guide$Syntax$ModuleMember(
						{
							fc: memberName,
							fg: A2(elm$core$String$join, '.', moduleParts)
						});
				}
			}
		}
	...
	function (isGood, offset, row, col, src, indent, context) {
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return {ev: col, f: context, l: indent, a: offset, fE: row, dE: src};
			} else {
...
var elm$parser$Parser$Advanced$variable = function (i) {
	return function (s) {
		var firstOffset = A3(elm$parser$Parser$Advanced$isSubChar, i.fT, s.a, s.dE);
		if (_Utils_eq(firstOffset, -1)) {
			...
			var s1 = _Utils_eq(firstOffset, -2) ? A7(elm$parser$Parser$Advanced$varHelp, i.e$, s.a + 1, s.fE + 1, 1, s.dE, s.l, s.f) : A7(elm$parser$Parser$Advanced$varHelp, i.e$, firstOffset, s.fE, s.ev + 1, s.dE, s.l, s.f);
			var name = A3(elm$core$String$slice, s.a, s1.a, s.dE);
			return A2(elm$core$Set$member, name, i.fA) ? A2(
				elm$parser$Parser$Advanced$Bad,
				false,
...
var elm$parser$Parser$variable = function (i) {
	return elm$parser$Parser$Advanced$variable(
		{c0: elm$parser$Parser$ExpectingVariable, e$: i.e$, fA: i.fA, fT: i.fT});
};
...
var elm$parser$Parser$Advanced$keyword = function (_n0) {
	...
	return function (s) {
		var _n1 = A5(elm$parser$Parser$Advanced$isSubString, kwd, s.a, s.fE, s.ev, s.dE);
		var newOffset = _n1.a;
		var newRow = _n1.b;
		var newCol = _n1.c;
...
var elm$parser$Parser$Advanced$bumpOffset = F2(
	function (newOffset, s) {
		return {ev: s.ev + (newOffset - s.a), f: s.f, l: s.l, a: newOffset, fE: s.fE, dE: s.dE};
	});
...
var elm$parser$Parser$Advanced$finalizeFloat = F6(
	function (invalid, expecting, intSettings, floatSettings, intPair, s) {
		...
		var floatOffset = A2(elm$parser$Parser$Advanced$consumeDotAndExp, intOffset, s.dE);
		if (floatOffset < 0) {
			return A2(
				elm$parser$Parser$Advanced$Bad,
				true,
				A4(elm$parser$Parser$Advanced$fromInfo, s.fE, s.ev - (floatOffset + s.a), invalid, s.f));
		} else {
				...
				if (_Utils_eq(intOffset, floatOffset)) {
					...
					if (floatSettings.$ === 1) {
						...
						var _n1 = elm$core$String$toFloat(
							A3(elm$core$String$slice, s.a, floatOffset, s.dE));
						if (_n1.$ === 1) {
							return A2(
								elm$parser$Parser$Advanced$Bad,
								true,
...
var elm$parser$Parser$Advanced$number = function (c) {
	return function (s) {
		if (A3(elm$parser$Parser$Advanced$isAsciiCode, 48, s.a, s.dE)) {
			var zeroOffset = s.a + 1;
			var baseOffset = zeroOffset + 1;
			return A3(elm$parser$Parser$Advanced$isAsciiCode, 120, zeroOffset, s.dE) ? A5(
				elm$parser$Parser$Advanced$finalizeInt,
				c.e3,
				c.eQ,
				baseOffset,
				A2(elm$parser$Parser$Advanced$consumeBase16, baseOffset, s.dE),
				s) : (A3(elm$parser$Parser$Advanced$isAsciiCode, 111, zeroOffset, s.dE) ? A5(
				elm$parser$Parser$Advanced$finalizeInt,
				c.e3,
				c.fl,
				baseOffset,
				A3(elm$parser$Parser$Advanced$consumeBase, 8, baseOffset, s.dE),
				s) : (A3(elm$parser$Parser$Advanced$isAsciiCode, 98, zeroOffset, s.dE) ? A5(
				elm$parser$Parser$Advanced$finalizeInt,
				c.e3,
				c.eh,
				baseOffset,
				A3(elm$parser$Parser$Advanced$consumeBase, 2, baseOffset, s.dE),
				s) : A6(
			...
			return A6(
				...
				c.e2,
				c.eK,
				A3(elm$parser$Parser$Advanced$consumeBase, 10, s.a, s.dE),
				s);
		}
	};
};
var elm$parser$Parser$number = function (i) {
	return elm$parser$Parser$Advanced$number(
		{
			eh: A2(elm$core$Result$fromMaybe, elm$parser$Parser$ExpectingBinary, i.eh),
			c0: elm$parser$Parser$ExpectingNumber,
			eK: A2(elm$core$Result$fromMaybe, elm$parser$Parser$ExpectingFloat, i.eK),
			eQ: A2(elm$core$Result$fromMaybe, elm$parser$Parser$ExpectingHex, i.eQ),
			e2: A2(elm$core$Result$fromMaybe, elm$parser$Parser$ExpectingInt, i.e2),
			e3: elm$parser$Parser$ExpectingNumber,
			fl: A2(elm$core$Result$fromMaybe, elm$parser$Parser$ExpectingOctal, i.fl)
		});
};
...
var elm$parser$Parser$Advanced$chompIf = F2(
	function (isGood, expecting) {
		return function (s) {
			var newOffset = A3(elm$parser$Parser$Advanced$isSubChar, isGood, s.a, s.dE);
			return _Utils_eq(newOffset, -1) ? A2(
				elm$parser$Parser$Advanced$Bad,
				false,
				...
				true,
				0,
				{ev: 1, f: s.f, l: s.l, a: s.a + 1, fE: s.fE + 1, dE: s.dE}) : A3(
				elm$parser$Parser$Advanced$Good,
				true,
				0,
				{ev: s.ev + 1, f: s.f, l: s.l, a: newOffset, fE: s.fE, dE: s.dE}));
		};
	});
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					...
					0,
					{ev: col, f: s0.f, l: s0.l, a: offset, fE: row, dE: s0.dE});
			} else {
				if (_Utils_eq(newOffset, -2)) {
					var $temp$isGood = isGood,
						$temp$offset = offset + 1,
...
var elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5(elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.a, s.fE, s.ev, s);
	};
};
	...
	function (accumulatedLines, accumulatedChunks, chunks) {
		...
		while (true) {
			if (chunks.b) {
				...
				var chunkType = _n1.a;
				var chunkText = _n1.b;
				var _n2 = elm$core$String$lines(chunkText);
				if (!_n2.b) {
					...
					if (!_n2.b.b) {
						var fragmentNotAtEndOfLine = _n2.a;
						...
						var fragmentAtEndOfLine = _n2.a;
						var followingFragments = _n2.b;
		...
		return elm$core$String$concat(
			_List_fromArray(
				[
					...
					elm$core$String$fromInt(first.fE),
					', column ',
					elm$core$String$fromInt(first.ev)
				]));
	} else {
...
var elm$parser$Parser$DeadEnd = F3(
	function (row, col, problem) {
		return {ev: col, dq: problem, fE: row};
	});
var elm$parser$Parser$problemToDeadEnd = function (p) {
	return A3(elm$parser$Parser$DeadEnd, p.fE, p.ev, p.dq);
};
...
var elm$parser$Parser$Advanced$run = F2(
	function (_n0, src) {
		var parse = _n0;
		var _n1 = parse(
			{ev: 1, f: _List_Nil, l: 1, a: 0, fE: 1, dE: src});
		if (!_n1.$) {
			var value = _n1.b;
		...
		while (true) {
			if (blocks.b) {
				...
				var parseCode = function (code) {
					var _n11 = author$project$Guide$Syntax$parse(code);
					if (!_n11.$) {
						var lines = _n11.a;
						return prepend(
...
var author$project$Guide$Document$tagBullets = F2(
	function (bullets, nextId) {
		if (bullets.b) {
			var first = bullets.a;
			var rest = bullets.b;
			var _n6 = A2(author$project$Guide$Document$tagBullets, rest, nextId);
			var taggedRest = _n6.a;
			var updatedId = _n6.b;
			var _n7 = A2(author$project$Guide$Document$tagChunks, first, updatedId);
			var taggedFirst = _n7.a;
			var finalId = _n7.b;
			return _Utils_Tuple2(
...
var author$project$Guide$Document$tagChunk = F2(
	function (chunk, nextId) {
		switch (chunk.$) {
			...
			default:
				var bullets = chunk.a;
				var _n4 = A2(author$project$Guide$Document$tagBullets, bullets, nextId);
				var taggedBullets = _n4.a;
				var updatedId = _n4.b;
				return _Utils_Tuple2(
...
var author$project$Guide$Document$tagChunks = F2(
	function (chunks, nextId) {
		if (chunks.b) {
			var first = chunks.a;
			var rest = chunks.b;
			var _n1 = A2(author$project$Guide$Document$tagChunks, rest, nextId);
			var taggedRest = _n1.a;
			var updatedId = _n1.b;
			var _n2 = A2(author$project$Guide$Document$tagChunk, first, updatedId);
			var taggedFirst = _n2.a;
			var finalId = _n2.b;
			return _Utils_Tuple2(
				A2(elm$core$List$cons, taggedFirst, taggedRest),
				finalId);
...
var pablohirafuji$elm_markdown$Markdown$Block$calcListIndentLength = function (_n0) {
	...
	var indentLength = (isIndentedCode || A2(elm$regex$Regex$contains, pablohirafuji$elm_markdown$Markdown$Block$blankLineRegex, rawLine)) ? (listBlock.v - indentSpaceLength) : listBlock.v;
	return _Utils_Tuple2(
		_Utils_update(
			listBlock,
			{v: indentLength}),
		...
		if (!asts.b) {
			return _List_fromArray(
				[
					_List_fromArray(
					[
						pablohirafuji$elm_markdown$Markdown$Block$BlankLine(match.e7)
					])
				]);
		} else {
			var ast = asts.a;
	...
	if (((_n0.b && _n0.b.b) && (!_n0.b.a.$)) && _n0.b.b.b) {
		...
		return elm$core$Maybe$Just(
			A2(
				...
				true,
				{
					b$: A2(elm$core$String$left, 1, fence),
					b0: elm$core$String$length(fence),
					v: A2(
						elm$core$Maybe$withDefault,
						0,
	...
	if (((((((_n0.b && (!_n0.a.$)) && _n0.b.b) && (!_n0.b.a.$)) && _n0.b.b.b) && (!_n0.b.b.a.$)) && _n0.b.b.b.b) && _n0.b.b.b.b.b) {
		...
		return elm$core$Maybe$Just(
			_Utils_Tuple3(
				{
					a4: delimiter,
					v: elm$core$String$length(indentString) + 1,
					ae: false,
					gf: A2(
						elm$core$Maybe$withDefault,
			...
			_Utils_Tuple3(
				{
					...
					v: elm$core$String$length(indentString) + 1,
					ae: false,
					gf: pablohirafuji$elm_markdown$Markdown$Block$Unordered
				},
				A2(elm$core$Maybe$withDefault, '', maybeIndentSpace),
				A2(elm$core$Maybe$withDefault, '', maybeRawLine)));
	} else {
...
var pablohirafuji$elm_markdown$Markdown$Block$continueOrCloseCodeFence = F3(
	function (fence, previousCode, rawLine) {
		return A2(pablohirafuji$elm_markdown$Markdown$Block$isCloseFenceLine, fence, rawLine) ? A2(
			...
			pablohirafuji$elm_markdown$Markdown$Block$CodeBlock,
			A2(pablohirafuji$elm_markdown$Markdown$Block$Fenced, true, fence),
			previousCode + (A2(pablohirafuji$elm_markdown$Markdown$Helpers$indentLine, fence.v, rawLine) + '\n'));
	});
				...
				switch (ast.a.$) {
					...
					case 6:
						...
						return (_Utils_cmp(
							...
							model.v) > -1) ? A5(pablohirafuji$elm_markdown$Markdown$Block$parseIndentedListLine, rawLine, model, items, ast, astTail) : A2(
				...
				A2(
					...
					function (a) {
						...
						function (a) {
							...
							A2(pablohirafuji$elm_markdown$Markdown$Helpers$indentLine, model.v, rawLine)))));
		} else {
			var item = items.a;
			var itemsTail = items.b;
			var indentedRawLine = A2(pablohirafuji$elm_markdown$Markdown$Helpers$indentLine, model.v, rawLine);
					...
					switch (item.a.$) {
						...
						case 6:
							...
							return (_Utils_cmp(
								...
								model_.v) > -1) ? updateList(model) : (pablohirafuji$elm_markdown$Markdown$Block$isBlankLineLast(items_) ? updateList(
								_Utils_update(
									model,
									{ae: true})) : updateList(model));
						default:
							break _n7$3;
					}
				} else {
			...
			if (ast.b) {
				switch (ast.a.$) {
					case 6:
						...
						var items = _n2.b;
						var astTail = ast.b;
						return _Utils_eq(listBlock.a4, model.a4) ? function (a) {
							return A2(elm$core$List$cons, a, astTail);
						}(
							A2(
								pablohirafuji$elm_markdown$Markdown$Block$List,
								_Utils_update(
									...
									{
										v: listBlock.v,
										ae: model.ae || pablohirafuji$elm_markdown$Markdown$Block$isBlankLineLast(items)
									}),
...
var pablohirafuji$elm_markdown$Markdown$Config$defaultOptions = {
	fx: pablohirafuji$elm_markdown$Markdown$Config$Sanitize(pablohirafuji$elm_markdown$Markdown$Config$defaultSanitizeOptions),
	fO: false
};
var pablohirafuji$elm_markdown$Markdown$InlineParser$initParser = F3(
	function (options, refs, rawText) {
		return {b: _List_Nil, dk: options, A: rawText, cv: refs, o: _List_Nil};
	});
...
var pablohirafuji$elm_markdown$Markdown$InlineParser$matchToInline = function (_n0) {
	...
	switch (_n1.$) {
		case 0:
			return pablohirafuji$elm_markdown$Markdown$Inline$Text(match.M);
		case 1:
			return pablohirafuji$elm_markdown$Markdown$Inline$HardLineBreak;
		case 2:
			return pablohirafuji$elm_markdown$Markdown$Inline$CodeInline(match.M);
		case 3:
			var _n2 = _n1.a;
			var text = _n2.a;
			var url = _n2.b;
...
var pablohirafuji$elm_markdown$Markdown$InlineParser$prepareChildMatch = F2(
	function (parentMatch, childMatch) {
		return _Utils_update(
			childMatch,
			{cZ: childMatch.cZ - parentMatch.Q, fT: childMatch.fT - parentMatch.Q, aY: childMatch.aY - parentMatch.Q, Q: childMatch.Q - parentMatch.Q});
	});
...
var pablohirafuji$elm_markdown$Markdown$InlineParser$organizeMatch = F2(
	function (_n0, matches) {
		...
		if (!matches.b) {
			...
			return (_Utils_cmp(prevMatch.cZ, match.fT) < 1) ? A2(elm$core$List$cons, match, matches) : (((_Utils_cmp(prevMatch.fT, match.fT) < 0) && (_Utils_cmp(prevMatch.cZ, match.cZ) > 0)) ? A2(
				elm$core$List$cons,
...
var pablohirafuji$elm_markdown$Markdown$InlineParser$normalMatch = function (text) {
	return {
		...
		b: _List_Nil,
		fT: 0,
		M: pablohirafuji$elm_markdown$Markdown$Helpers$formatStr(text),
		aY: 0,
		Q: 0,
		gf: pablohirafuji$elm_markdown$Markdown$InlineParser$NormalType
	};
};
var pablohirafuji$elm_markdown$Markdown$InlineParser$parseTextMatch = F3(
	function (rawText, _n2, parsedMatches) {
		...
		var updtMatch = _Utils_update(
			matchModel,
			{
				b: A3(pablohirafuji$elm_markdown$Markdown$InlineParser$parseTextMatches, matchModel.M, _List_Nil, matchModel.b)
			});
		if (!parsedMatches.b) {
			var finalStr = A2(elm$core$String$dropLeft, matchModel.cZ, rawText);
			...
			return _Utils_eq(matchHead.gf, pablohirafuji$elm_markdown$Markdown$InlineParser$NormalType) ? A2(elm$core$List$cons, updtMatch, parsedMatches) : (_Utils_eq(matchModel.cZ, matchHead.fT) ? A2(elm$core$List$cons, updtMatch, parsedMatches) : ((_Utils_cmp(matchModel.cZ, matchHead.fT) < 0) ? A2(
				elm$core$List$cons,
				updtMatch,
				A2(
					elm$core$List$cons,
					pablohirafuji$elm_markdown$Markdown$InlineParser$normalMatch(
						A3(elm$core$String$slice, matchModel.cZ, matchHead.fT, rawText)),
		...
		while (true) {
			if (!matches.b) {
				if (!parsedMatches.b) {
					...
					return (matchModel.fT > 0) ? A2(
						elm$core$List$cons,
						pablohirafuji$elm_markdown$Markdown$InlineParser$normalMatch(
							A2(elm$core$String$left, matchModel.fT, rawText)),
						parsedMatches) : parsedMatches;
				}
			} else {
				var match = matches.a;
			...
			if (!_n0.a.$) {
				...
				if (_n0.b.b && (!_n0.b.a.$)) {
					...
					return elm$core$Maybe$Just(
						{
							eZ: regMatch.eZ,
							c: elm$core$String$length(regMatch.e7),
			...
			o: A2(
				...
				_Utils_ap(
					...
					_Utils_ap(
						...
						_Utils_ap(
							A2(pablohirafuji$elm_markdown$Markdown$InlineParser$findHardBreakTokens, model.dk.fO, model.A),
							_Utils_ap(
...
var pablohirafuji$elm_markdown$Markdown$InlineParser$addToken = F2(
	function (model, token) {
		return _Utils_update(
			model,
			{
				o: A2(elm$core$List$cons, token, model.o)
			});
	});
	...
	A2(
		...
		function (match) {
			return A2(
				elm$core$Maybe$withDefault,
				match.e7,
				elm$url$Url$percentDecode(match.e7));
		}));
...
var pablohirafuji$elm_markdown$Markdown$InlineParser$autolinkToMatch = function (_n0) {
	var match = _n0;
	return A2(elm$regex$Regex$contains, pablohirafuji$elm_markdown$Markdown$InlineParser$urlRegex, match.M) ? elm$core$Result$Ok(
		_Utils_update(
			match,
			{
				gf: pablohirafuji$elm_markdown$Markdown$InlineParser$AutolinkType(
					_Utils_Tuple2(
						match.M,
						pablohirafuji$elm_markdown$Markdown$InlineParser$encodeUrl(match.M)))
		...
		if ((((_n0.b && _n0.b.b) && _n0.b.b.b) && _n0.b.b.b.b) && _n0.b.b.b.b.b) {
			...
			var toMatch = function (rawUrl) {
				return _Utils_update(
					matchModel,
					{
						cZ: matchModel.cZ + elm$core$String$length(regexMatch.e7),
						gf: function () {
							var _n5 = matchModel.gf;
							if (_n5.$ === 5) {
	...
	function (matchModel, model, maybeRegexMatch) {
		...
		var toMatch = function (urlTitle) {
			return _Utils_update(
				matchModel,
				{
					cZ: matchModel.cZ + regexMatchLength,
					gf: function () {
						var _n0 = matchModel.gf;
						if (_n0.$ === 5) {
							return pablohirafuji$elm_markdown$Markdown$InlineParser$ImageType;
						} else {
							return pablohirafuji$elm_markdown$Markdown$InlineParser$LinkType;
...
var pablohirafuji$elm_markdown$Markdown$InlineParser$checkParsedAheadOverlapping = function (parser) {
	...
	if (!_n0.b) {
		...
		var overlappingMatches = A2(
			...
			function (_n1) {
				var testMatch = _n1;
				return (_Utils_cmp(match.cZ, testMatch.fT) > 0) && (_Utils_cmp(match.cZ, testMatch.cZ) < 0);
			},
			remainMatches);
...
var pablohirafuji$elm_markdown$Markdown$InlineParser$emailAutolinkTypeToMatch = function (_n0) {
	var match = _n0;
	return A2(elm$regex$Regex$contains, pablohirafuji$elm_markdown$Markdown$InlineParser$emailRegex, match.M) ? elm$core$Result$Ok(
		_Utils_update(
			match,
			{
				gf: pablohirafuji$elm_markdown$Markdown$InlineParser$AutolinkType(
					_Utils_Tuple2(
						match.M,
						'mailto:' + pablohirafuji$elm_markdown$Markdown$InlineParser$encodeUrl(match.M)))
			})) : elm$core$Result$Err(match);
};
var pablohirafuji$elm_markdown$Markdown$InlineParser$filterTokens = F2(
	function (filter, model) {
		return _Utils_update(
			model,
			{
				o: A2(elm$core$List$filter, filter, model.o)
			});
	});
	...
	function (model, _n0) {
		...
		if (_n1.$ === 2) {
			...
			return A2(
				...
				elm$core$List$head(
					A3(elm$regex$Regex$findAtMost, 1, pablohirafuji$elm_markdown$Markdown$InlineParser$htmlRegex, match.M)));
		}
	});
...
var pablohirafuji$elm_markdown$Markdown$InlineParser$reverseTokens = function (model) {
	return _Utils_update(
		model,
		{
			o: elm$core$List$reverse(model.o)
		});
};
var pablohirafuji$elm_markdown$Markdown$InlineParser$tokenToMatch = F2(
	function (token, type_) {
		return {cZ: token.eZ + token.c, b: _List_Nil, fT: token.eZ, M: '', aY: 0, Q: 0, gf: type_};
	});
var pablohirafuji$elm_markdown$Markdown$InlineParser$lineBreakTTM = function (_n0) {
	...
	while (true) {
		...
		if (!tokens.b) {
			...
			if (_Utils_eq(token.g, pablohirafuji$elm_markdown$Markdown$InlineParser$HardLineBreakToken) || (_Utils_eq(token.g, pablohirafuji$elm_markdown$Markdown$InlineParser$SoftLineBreakToken) && model.dk.fO)) {
		...
		if (!_n0.b) {
			...
			return _Utils_Tuple2(
				A2(
					elm$core$List$filter,
					function (token) {
						return _Utils_cmp(token.eZ, match.cZ) > -1;
					},
					tokensTail),
				parser);
		}
...
var pablohirafuji$elm_markdown$Markdown$InlineParser$emphasisToMatch = F4(
	function (closeToken, tokensTail, model, _n15) {
		...
		var updt = (!remainLength) ? {bu: closeToken, bb: openToken, bN: remainTokens, bQ: tokensTail} : ((remainLength > 0) ? {
			bu: closeToken,
			bb: _Utils_update(
				openToken,
		...
		var match = A6(
			...
			pablohirafuji$elm_markdown$Markdown$InlineParser$EmphasisType(updt.bb.c),
			updt.bb,
			updt.bu,
			elm$core$List$reverse(innerTokens));
		return _Utils_Tuple2(
				...
				return pablohirafuji$elm_markdown$Markdown$InlineParser$linkImageTypeTTM(
					A2(
						...
						A2(
							...
							A2(pablohirafuji$elm_markdown$Markdown$InlineParser$findToken, pablohirafuji$elm_markdown$Markdown$InlineParser$isLinkTypeOrImageOpenToken, model.o))));
			} else {
	...
	function (closeToken, tokensTail, model, _n1) {
		...
		var removeOpenToken = _Utils_Tuple2(
			...
			_Utils_update(
				model,
				{
					o: _Utils_ap(innerTokens, remainTokens)
				}));
		...
		var linkOpenTokenToInactive = function (model_) {
			...
			return _Utils_update(
				model_,
				{
					o: A2(elm$core$List$map, process, model_.o)
				});
		};
				...
				return A2(
					...
					function (a) {
						...
						A2(
							...
							A2(pablohirafuji$elm_markdown$Markdown$Block$parseInlines, maybeOptions, model.ae),
							function (b) {
...
var pablohirafuji$elm_markdown$Markdown$Block$dropRefString = F2(
	function (rawText, inlineMatch) {
		var strippedText = A2(elm$core$String$dropLeft, inlineMatch.cd, rawText);
...
var pablohirafuji$elm_markdown$Markdown$Block$insertLinkMatch = F2(
	function (refs, linkMatch) {
		return A2(elm$core$Dict$member, linkMatch.aw, refs) ? refs : A3(
			elm$core$Dict$insert,
			linkMatch.aw,
			_Utils_Tuple2(linkMatch.aG, linkMatch.ce),
			refs);
	});
var pablohirafuji$elm_markdown$Markdown$Block$extractUrlTitleRegex = function (regexMatch) {
	...
	if ((((((_n0.b && (!_n0.a.$)) && _n0.b.b) && _n0.b.b.b) && _n0.b.b.b.b) && _n0.b.b.b.b.b) && _n0.b.b.b.b.b.b) {
		...
		var toReturn = function (rawUrl) {
			return {
				aw: rawText,
				cd: elm$core$String$length(regexMatch.e7),
				ce: pablohirafuji$elm_markdown$Markdown$Helpers$returnFirstJust(
					_List_fromArray(
						[maybeTitleSingleQuotes, maybeTitleDoubleQuotes, maybeTitleParenthesis])),
				aG: rawUrl
			};
...
var pablohirafuji$elm_markdown$Markdown$Block$maybeLinkMatch = function (rawText) {
	return A2(
		elm$core$Maybe$andThen,
		function (linkMatch) {
			return ((linkMatch.aG === '') || (linkMatch.aw === '')) ? elm$core$Maybe$Nothing : elm$core$Maybe$Just(linkMatch);
		},
		A2(
			elm$core$Maybe$map,
			function (linkMatch) {
				return _Utils_update(
					linkMatch,
					{
						aw: pablohirafuji$elm_markdown$Markdown$Helpers$prepareRefLabel(linkMatch.aw)
					});
			},
			A2(
				elm$core$Maybe$andThen,
...
var author$project$Guide$Document$parse = F2(
	function (widgets, markdown) {
		var options = {fx: pablohirafuji$elm_markdown$Markdown$Config$ParseUnsafe, fO: false};
		var blocks = A2(
			...
			return A3(
				...
				F2(
					function (titleText, bodyChunks) {
						return _Utils_Tuple2(
							{
								bt: A2(author$project$Guide$Document$tagChunks, bodyChunks, 1).a,
								dM: titleText
							},
...
var author$project$Guide$handleMarkdown = F4(
	function (page, fragment, widgets, result) {
		if (!result.$) {
			var markdown = result.a.de;
			var lastModified = result.a.aP;
			var _n1 = A2(author$project$Guide$Document$parse, widgets, markdown);
			if (!_n1.$) {
				var _n2 = _n1.a;
				var document = _n2.a;
				var imagesToLoad = _n2.b;
				return author$project$Guide$DocumentLoaded(
					{bA: document, au: fragment, bD: imagesToLoad, aP: lastModified, bK: page});
			} else {
				var message = _n1.a;
		...
		return elm$parser$Parser$Advanced$number(
			{
				...
				e3: invalid,
				fl: elm$core$Result$Err(invalid)
			});
	});
...
var author$project$Guide$toDateString = F6(
	function (day, month, year, _n0, _n1, _n2) {
...
var author$project$Guide$handleResponse = function (response) {
	switch (response.$) {
		...
		case 3:
			...
			return elm$core$Result$Err(
				'Got an HTTP ' + (elm$core$String$fromInt(metadata.fV) + ' error code when loading page'));
		default:
			var metadata = response.a;
			...
			var parsedDate = A2(
				...
				A2(elm$core$Dict$get, 'last-modified', metadata.eO));
			return elm$core$Result$Ok(
				{aP: parsedDate, de: content});
	}
};
...
var elm$http$Http$request = function (r) {
	return elm$http$Http$command(
		elm$http$Http$Request(
			{aI: false, ei: r.ei, c$: r.c$, eO: r.eO, G: r.G, H: r.H, N: r.N, aG: r.aG}));
};
var elm$http$Http$get = function (r) {
	return elm$http$Http$request(
		{ei: elm$http$Http$emptyBody, c$: r.c$, eO: _List_Nil, G: 'GET', H: elm$core$Maybe$Nothing, N: elm$core$Maybe$Nothing, aG: r.aG});
};
		...
		return elm$http$Http$get(
			{
				...
				aG: A2(author$project$Guide$Page$sourceUrl, rootPath, page)
			});
	});
...
var elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {au: fragment, c5: host, fv: path, dp: port_, dt: protocol, du: query};
	});
	...
	if (!fragment.$) {
		...
		return A2(
			...
			A2(
				...
				function (_n1) {
					var element = _n1.eE;
					return A2(elm$browser$Browser$Dom$setViewport, 0, element.gl);
				},
...
var author$project$Guide$Page$Route = F2(
	function (query, fragment) {
		return {au: fragment, du: query};
	});
var elm$url$Url$Parser$Parser = elm$core$Basics$identity;
var elm$url$Url$Parser$State = F5(
	function (visited, unvisited, params, frag, value) {
		return {at: frag, aA: params, al: unvisited, Z: value, aH: visited};
	});
var elm$url$Url$Parser$fragment = function (toFrag) {
	return function (_n0) {
		var visited = _n0.aH;
		var unvisited = _n0.al;
		var params = _n0.aA;
		var frag = _n0.at;
		var value = _n0.Z;
		return _List_fromArray(
		...
		return elm$url$Url$Parser$getFirstMatch(
			parser(
				A5(
					...
					elm$url$Url$Parser$prepareQuery(url.du),
					url.au,
					elm$core$Basics$identity)));
	});
...
var author$project$Guide$handleNewUrl = F7(
	function (currentState, rootPath, readmePage, allPages, screenClass, url, widgets) {
		...
		if (!_n0.$) {
			if (!_n0.a.$) {
				var page = _n0.a.a;
				var loadNewPage = A4(author$project$Guide$loadPage, rootPath, page, url.au, widgets);
				var command = function () {
					if (currentState.$ === 3) {
						var current = currentState.a;
						return _Utils_eq(page, current.bK) ? author$project$Guide$scrollTo(url.au) : loadNewPage;
					} else {
						return loadNewPage;
					}
				}();
				...
				var _n2 = _n0.a;
				if (screenClass === 1) {
					var loadReadme = A4(author$project$Guide$loadPage, rootPath, readmePage, url.au, widgets);
					return _Utils_Tuple2(
						currentState,
						function () {
							if (currentState.$ === 3) {
								var current = currentState.a;
								return author$project$Guide$Page$isReadme(current.bK) ? author$project$Guide$scrollTo(url.au) : loadReadme;
							} else {
								return loadReadme;
							}
						}());
...
var elm$project_metadata_utils$Elm$Docs$Module = F6(
	function (name, comment, unions, aliases, values, binops) {
		return {a_: aliases, cM: binops, aK: comment, fh: name, bl: unions, dR: values};
	});
var elm$json$Json$Decode$map4 = _Json_map4;
var elm$project_metadata_utils$Elm$Docs$Alias = F4(
	function (name, comment, args, tipe) {
		return {ab: args, aK: comment, fh: name, bh: tipe};
	});
...
var elm$parser$Parser$Advanced$sequence = function (i) {
	return A2(
		elm$parser$Parser$Advanced$skip,
		elm$parser$Parser$Advanced$token(i.fT),
		A2(
			elm$parser$Parser$Advanced$skip,
			i.dD,
			A5(
				elm$parser$Parser$Advanced$sequenceEnd,
				elm$parser$Parser$Advanced$token(i.cZ),
				i.dD,
				i.c8,
...
var elm$parser$Parser$sequence = function (i) {
	return elm$parser$Parser$Advanced$sequence(
		{
			cZ: elm$parser$Parser$toToken(i.cZ),
			c8: i.c8,
			dB: elm$parser$Parser$toToken(i.dB),
			dD: i.dD,
			fT: elm$parser$Parser$toToken(i.fT),
			dO: elm$parser$Parser$toAdvancedTrailing(i.dO)
		});
};
...
var elm$project_metadata_utils$Elm$Type$var = function (isFirst) {
	return elm$parser$Parser$variable(
		{e$: elm$project_metadata_utils$Elm$Type$isInnerVarChar, fA: elm$core$Set$empty, fT: isFirst});
};
...
function elm$project_metadata_utils$Elm$Type$cyclic$tuple() {
	return A2(
		...
		elm$parser$Parser$sequence(
			{
				cZ: ')',
				c8: elm$project_metadata_utils$Elm$Type$cyclic$tipe(),
				dB: ',',
...
var elm$project_metadata_utils$Elm$Docs$Binop = F5(
	function (name, comment, tipe, associativity, precedence) {
		return {eb: associativity, aK: comment, fh: name, fw: precedence, bh: tipe};
	});
...
var elm$project_metadata_utils$Elm$Docs$Union = F4(
	function (name, comment, args, tags) {
		return {ab: args, aK: comment, fh: name, bg: tags};
	});
...
var elm$project_metadata_utils$Elm$Docs$Value = F3(
	function (name, comment, tipe) {
		return {aK: comment, fh: name, bh: tipe};
	});
...
var author$project$Guide$init = F8(
	function (author, packageName, givenWidgets, readmePage, allPages, flags, url, navigationKey) {
		...
		var screenClass = author$project$Guide$Screen$classify(flags.dW);
		var rootPath = A2(
			elm$core$List$filter,
			A2(elm$core$Basics$composeL, elm$core$Basics$not, elm$core$String$isEmpty),
			A2(elm$core$String$split, '/', url.fv));
		...
		var loadDocs = elm$http$Http$get(
			{
				c$: A2(elm$http$Http$expectJson, author$project$Guide$DocsJsonResponse, moduleNamesDecoder),
				aG: 'docs.json'
			});
		var _n0 = A7(author$project$Guide$handleNewUrl, author$project$Guide$Loading, rootPath, readmePage, allPages, screenClass, url, widgets);
		var state = _n0.a;
		var pageCommand = _n0.b;
		return _Utils_Tuple2(
			{bn: allPages, an: author, ba: elm$core$Set$empty, di: navigationKey, W: packageName, bM: readmePage, aV: rootPath, K: screenClass, B: state, bm: widgets},
...
var author$project$Guide$update = F2(
	function (message, model) {
		switch (message.$) {
			...
			case 1:
				var url = message.a;
				var _n2 = A7(author$project$Guide$handleNewUrl, model.B, model.aV, model.bM, model.bn, model.K, url, model.bm);
				var newState = _n2.a;
				var command = _n2.b;
				return _Utils_Tuple2(
					_Utils_update(
			...
			case 2:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							B: author$project$Guide$Error(string)
						}),
					elm$core$Platform$Cmd$none);
			case 3:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							B: author$project$Guide$Loaded(loaded)
						}),
					elm$core$Set$isEmpty(loaded.bD) ? author$project$Guide$scrollTo(loaded.au) : elm$core$Platform$Cmd$none);
			case 4:
				if (!message.a.$) {
					...
					if (_n4.$ === 3) {
						var current = _n4.a;
						var updatedImagesToLoad = A2(elm$core$Set$remove, url, current.bD);
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									B: author$project$Guide$Loaded(
										_Utils_update(
											current,
											{bD: updatedImagesToLoad}))
								}),
							elm$core$Set$isEmpty(updatedImagesToLoad) ? author$project$Guide$scrollTo(current.au) : elm$core$Platform$Cmd$none);
					} else {
						return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
					}
				}
				...
				if (!message.a.$) {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								ba: elm$core$Set$fromList(moduleNames)
							}),
						elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(model, elm$core$Platform$Cmd$none);
...
var mdgriffith$elm_ui$Internal$Style$classes = {d_: 'a', bU: 'atv', d0: 'ab', d1: 'cx', d2: 'cy', d3: 'acb', d4: 'accx', d5: 'accy', d6: 'acr', cI: 'al', cJ: 'ar', d7: 'at', bV: 'ah', bW: 'av', d9: 's', ef: 'bh', eg: 'b', ej: 'w7', el: 'bd', em: 'bdt', bo: 'bn', en: 'bs', bs: 'cpe', es: 'cp', et: 'cpx', eu: 'cpy', ex: 'c', bw: 'ctr', bx: 'cb', by: 'ccx', ac: 'ccy', a0: 'cl', bz: 'cr', ey: 'ct', eA: 'cptr', eB: 'ctxt', eL: 'fcs', eM: 'fs', eN: 'g', b2: 'hbh', bC: 'hc', b3: 'hf', c4: 'hfp', eS: 'hv', eU: 'ic', eW: 'fr', e0: 'iml', e1: 'it', e4: 'i', aQ: 'nb', dj: 'notxt', fm: 'ol', fo: 'or', az: 'oq', fs: 'oh', bK: 'pg', dm: 'p', fu: 'ppe', fC: 'ui', fE: 'r', fG: 'sb', fH: 'sbx', fI: 'sby', fJ: 'sbt', fM: 'e', fN: 'cap', fP: 'sev', fZ: 'sk', M: 't', f1: 'tc', f2: 'w8', f3: 'w2', f4: 'w9', f5: 'tj', bP: 'tja', f6: 'tl', f7: 'w3', f8: 'w5', f9: 'w4', ga: 'tr', gb: 'w6', gc: 'w1', gd: 'tun', dP: 'ts', aF: 'clr', gg: 'u', cE: 'wc', dX: 'we', cF: 'wf', dY: 'wfp', cG: 'wrp'};
var mdgriffith$elm_ui$Internal$Model$columnClass = mdgriffith$elm_ui$Internal$Style$classes.d9 + (' ' + mdgriffith$elm_ui$Internal$Style$classes.ex);
var mdgriffith$elm_ui$Internal$Model$gridClass = mdgriffith$elm_ui$Internal$Style$classes.d9 + (' ' + mdgriffith$elm_ui$Internal$Style$classes.eN);
var mdgriffith$elm_ui$Internal$Model$pageClass = mdgriffith$elm_ui$Internal$Style$classes.d9 + (' ' + mdgriffith$elm_ui$Internal$Style$classes.bK);
var mdgriffith$elm_ui$Internal$Model$paragraphClass = mdgriffith$elm_ui$Internal$Style$classes.d9 + (' ' + mdgriffith$elm_ui$Internal$Style$classes.dm);
var mdgriffith$elm_ui$Internal$Model$rowClass = mdgriffith$elm_ui$Internal$Style$classes.d9 + (' ' + mdgriffith$elm_ui$Internal$Style$classes.fE);
var mdgriffith$elm_ui$Internal$Model$singleClass = mdgriffith$elm_ui$Internal$Style$classes.d9 + (' ' + mdgriffith$elm_ui$Internal$Style$classes.fM);
	...
	switch (style.$) {
		...
		case 8:
			...
			return 'grid-rows-' + (A2(
				elm$core$String$join,
				'-',
				A2(elm$core$List$map, mdgriffith$elm_ui$Internal$Model$lengthClassName, template.fF)) + ('-cols-' + (A2(
				elm$core$String$join,
				'-',
				A2(elm$core$List$map, mdgriffith$elm_ui$Internal$Model$lengthClassName, template.R)) + ('-space-x-' + (mdgriffith$elm_ui$Internal$Model$lengthClassName(template.fQ.a) + ('-space-y-' + mdgriffith$elm_ui$Internal$Model$lengthClassName(template.fQ.b)))))));
		case 9:
			var pos = style.a;
			return 'gp grid-pos-' + (elm$core$String$fromInt(pos.fE) + ('-' + (elm$core$String$fromInt(pos.ev) + ('-' + (elm$core$String$fromInt(pos.dW) + ('-' + elm$core$String$fromInt(pos.eP)))))));
		case 11:
...
var mdgriffith$elm_ui$Internal$Model$formatBoxShadow = function (shadow) {
	return A2(
		...
		A2(
			...
			_List_fromArray(
				[
					shadow.c7 ? elm$core$Maybe$Just('inset') : elm$core$Maybe$Nothing,
					elm$core$Maybe$Just(
...
var mdgriffith$elm_ui$Internal$Model$renderFocusStyle = function (focus) {
	return A2(
		...
		mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.d9) + (':focus .focusable, ' + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.d9) + '.focusable:focus')),
		A2(
			elm$core$List$filterMap,
			elm$core$Basics$identity,
			_List_fromArray(
...
var mdgriffith$elm_ui$Internal$Style$baseSheet = _List_fromArray(
	[
		...
		A2(
		mdgriffith$elm_ui$Internal$Style$Class,
		mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.d9) + ':focus',
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap(mdgriffith$elm_ui$Internal$Style$classes.eS, mdgriffith$elm_ui$Internal$Style$classes.aF)) + ':hover',
				_List_fromArray(
					[
						A2(mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				mdgriffith$elm_ui$Internal$Style$Descriptor,
				mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap(mdgriffith$elm_ui$Internal$Style$classes.eS, mdgriffith$elm_ui$Internal$Style$classes.az)) + ':hover',
				_List_fromArray(
					[
						A2(mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				...
				mdgriffith$elm_ui$Internal$Style$Descriptor,
				mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap(mdgriffith$elm_ui$Internal$Style$classes.eL, mdgriffith$elm_ui$Internal$Style$classes.aF)) + ':focus',
				_List_fromArray(
					[
						A2(mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				mdgriffith$elm_ui$Internal$Style$Descriptor,
				mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap(mdgriffith$elm_ui$Internal$Style$classes.eL, mdgriffith$elm_ui$Internal$Style$classes.az)) + ':focus',
				_List_fromArray(
					[
						A2(mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				...
				mdgriffith$elm_ui$Internal$Style$Descriptor,
				mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap(mdgriffith$elm_ui$Internal$Style$classes.bU, mdgriffith$elm_ui$Internal$Style$classes.aF)) + ':active',
				_List_fromArray(
					[
						A2(mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				mdgriffith$elm_ui$Internal$Style$Descriptor,
				mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap(mdgriffith$elm_ui$Internal$Style$classes.bU, mdgriffith$elm_ui$Internal$Style$classes.az)) + ':active',
				_List_fromArray(
					[
						A2(mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				...
				_List_fromArray(
					[
						...
						A2(
						mdgriffith$elm_ui$Internal$Style$Child,
						'u:first-of-type.' + mdgriffith$elm_ui$Internal$Style$classes.d6,
						_List_fromArray(
							[
						...
						A2(
						mdgriffith$elm_ui$Internal$Style$Child,
						's:first-of-type.' + mdgriffith$elm_ui$Internal$Style$classes.d4,
						_List_fromArray(
							[
								A2(mdgriffith$elm_ui$Internal$Style$Prop, 'flex-grow', '1'),
								A2(
						...
						A2(
						mdgriffith$elm_ui$Internal$Style$Child,
						's:last-of-type.' + mdgriffith$elm_ui$Internal$Style$classes.d4,
						_List_fromArray(
							[
								A2(mdgriffith$elm_ui$Internal$Style$Prop, 'flex-grow', '1'),
								A2(
						...
						A2(
						mdgriffith$elm_ui$Internal$Style$Child,
						's:only-of-type.' + mdgriffith$elm_ui$Internal$Style$classes.d4,
						_List_fromArray(
							[
								A2(mdgriffith$elm_ui$Internal$Style$Prop, 'flex-grow', '1'),
								A2(
						...
						A2(
						mdgriffith$elm_ui$Internal$Style$Child,
						's:last-of-type.' + (mdgriffith$elm_ui$Internal$Style$classes.d4 + ' ~ u'),
						_List_fromArray(
							[
								A2(mdgriffith$elm_ui$Internal$Style$Prop, 'flex-grow', '0')
							])),
						A2(
						mdgriffith$elm_ui$Internal$Style$Child,
						'u:first-of-type.' + (mdgriffith$elm_ui$Internal$Style$classes.d6 + (' ~ s.' + mdgriffith$elm_ui$Internal$Style$classes.d4)),
						_List_fromArray(
							[
								A2(mdgriffith$elm_ui$Internal$Style$Prop, 'flex-grow', '0')
							])),
				...
				_List_fromArray(
					[
						...
						A2(
						mdgriffith$elm_ui$Internal$Style$Child,
						'u:first-of-type.' + (mdgriffith$elm_ui$Internal$Style$classes.d3 + (' ~ s.' + mdgriffith$elm_ui$Internal$Style$classes.d5)),
						_List_fromArray(
							[
								A2(mdgriffith$elm_ui$Internal$Style$Prop, 'flex-grow', '0')
							])),
				...
				_List_fromArray(
					[
						...
						A2(
						mdgriffith$elm_ui$Internal$Style$Child,
						mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.d9 + ':first-child'),
						_List_fromArray(
							[
								A2(mdgriffith$elm_ui$Internal$Style$Prop, 'margin', '0 !important')
							])),
						...
						mdgriffith$elm_ui$Internal$Style$Child,
						mdgriffith$elm_ui$Internal$Style$dot(
							mdgriffith$elm_ui$Internal$Style$classes.d9 + (mdgriffith$elm_ui$Internal$Style$selfName(3) + (':first-child + .' + mdgriffith$elm_ui$Internal$Style$classes.d9))),
						_List_fromArray(
							[
								A2(mdgriffith$elm_ui$Internal$Style$Prop, 'margin', '0 !important')
							])),
						...
						mdgriffith$elm_ui$Internal$Style$Child,
						mdgriffith$elm_ui$Internal$Style$dot(
							mdgriffith$elm_ui$Internal$Style$classes.d9 + (mdgriffith$elm_ui$Internal$Style$selfName(2) + (':first-child + .' + mdgriffith$elm_ui$Internal$Style$classes.d9))),
						_List_fromArray(
							[
								A2(mdgriffith$elm_ui$Internal$Style$Prop, 'margin', '0 !important')
							])),
...
var mdgriffith$elm_ui$Internal$Style$explainer = '\n.explain {\n    border: 6px solid rgb(174, 121, 15) !important;\n}\n.explain > .' + (mdgriffith$elm_ui$Internal$Style$classes.d9 + (' {\n    border: 4px dashed rgb(0, 151, 167) !important;\n}\n\n.ctr {\n    border: none !important;\n}\n.explain > .ctr > .' + (mdgriffith$elm_ui$Internal$Style$classes.d9 + ' {\n    border: 4px dashed rgb(0, 151, 167) !important;\n}\n\n')));
...
var mdgriffith$elm_ui$Internal$Style$overrides = '@media screen and (-ms-high-contrast: active), (-ms-high-contrast: none) {' + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.d9) + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.fE) + (' > ' + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.d9) + (' { flex-basis: auto !important; } ' + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.d9) + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.fE) + (' > ' + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.d9) + (mdgriffith$elm_ui$Internal$Style$dot(mdgriffith$elm_ui$Internal$Style$classes.bw) + (' { flex-basis: auto !important; }}' + (mdgriffith$elm_ui$Internal$Style$sliderOverrides + mdgriffith$elm_ui$Internal$Style$explainer))))))))))));
var mdgriffith$elm_ui$Internal$Style$Intermediate = elm$core$Basics$identity;
var mdgriffith$elm_ui$Internal$Style$emptyIntermediate = F2(
	function (selector, closing) {
		return {bv: closing, x: _List_Nil, ak: _List_Nil, X: selector};
	});
					...
					case 2:
						...
						return _Utils_update(
							rendered,
							{
								x: A2(
									elm$core$List$cons,
									{bv: '\n}', x: _List_Nil, ak: props, X: '@supports (' + (prop + (':' + (value + (') {' + parent.X))))},
									rendered.x)
							});
					case 4:
						var selector = rule.a;
...
var mdgriffith$elm_ui$Internal$Style$renderCompact = function (styleClasses) {
	...
	var renderClass = function (rule) {
		...
		if (!_n2.b) {
			...
			return rule.X + ('{' + (renderValues(rule.ak) + (rule.bv + '}')));
		}
	};
...
var mdgriffith$elm_ui$Internal$Model$renderFontAdjustmentRule = F3(
	function (fontToAdjust, _n0, otherFontName) {
		...
		return A2(
			...
			' ',
			_Utils_ap(
				A3(mdgriffith$elm_ui$Internal$Model$fontRule, name, mdgriffith$elm_ui$Internal$Style$classes.fN, capital),
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					'.' + (name + ('.' + (mdgriffith$elm_ui$Internal$Style$classes.fN + (', ' + ('.' + (name + (' .' + mdgriffith$elm_ui$Internal$Style$classes.fN))))))),
					_List_fromArray(
						[
					...
					A2(
					mdgriffith$elm_ui$Internal$Model$bracket,
					'.' + (name + ('.' + (mdgriffith$elm_ui$Internal$Style$classes.fN + ('> .' + (mdgriffith$elm_ui$Internal$Style$classes.M + (', .' + (name + (' .' + (mdgriffith$elm_ui$Internal$Style$classes.fN + (' > .' + mdgriffith$elm_ui$Internal$Style$classes.M)))))))))),
					_List_fromArray(
						[
...
var mdgriffith$elm_ui$Internal$Model$adjust = F3(
	function (size, height, vertical) {
		return {eP: height / size, cz: size, dU: vertical};
	});
var mdgriffith$elm_ui$Internal$Model$convertAdjustment = function (adjustment) {
	var lines = _List_fromArray(
		[adjustment.ep, adjustment.ee, adjustment.eD, adjustment.e6]);
	var lineHeight = 1.5;
	...
	return {
		ep: A3(mdgriffith$elm_ui$Internal$Model$adjust, capitalSize, ascender - newBaseline, capitalVertical),
	...
	return _Utils_Tuple2(
		...
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'line-height',
				elm$core$String$fromFloat(converted.eP)),
				_Utils_Tuple2(
				'vertical-align',
					...
					switch (pseudo) {
						...
						case 0:
							...
							return A2(
								...
								'\n',
								_List_fromArray(
									[selector + ('-fs:focus {' + (renderedProps + '\n}')), '.' + (mdgriffith$elm_ui$Internal$Style$classes.d9 + (':focus ~ ' + (selector + ('-fs:not(.focus)  {' + (renderedProps + '\n}'))))), '.' + (mdgriffith$elm_ui$Internal$Style$classes.d9 + (':focus ' + (selector + ('-fs  {' + (renderedProps + '\n}'))))), '.focusable-parent:focus ~ ' + ('.' + (mdgriffith$elm_ui$Internal$Style$classes.d9 + (' ' + (selector + ('-fs {' + (renderedProps + '\n}'))))))]));
						default:
			...
			function (rule, maybePseudo) {
				switch (rule.$) {
					...
					case 5:
						...
						var single = '.' + mdgriffith$elm_ui$Internal$Style$classes.fM;
						var row = '.' + mdgriffith$elm_ui$Internal$Style$classes.fE;
						...
						var column = '.' + mdgriffith$elm_ui$Internal$Style$classes.ex;
						var _class = '.' + cls;
						var any = '.' + mdgriffith$elm_ui$Internal$Style$classes.d9;
						return elm$core$String$concat(
							_List_fromArray(
								[
									A3(
					...
					case 8:
						...
						var xSpacing = toGridLength(template.fQ.a);
						var ySpacing = toGridLength(template.fQ.b);
						var rows = function (x) {
						...
						var msColumns = function (x) {
							...
							A2(
								...
								ySpacing,
								A2(elm$core$List$map, toGridLength, template.R)));
						var gapY = 'grid-row-gap:' + (toGridLength(template.fQ.b) + ';');
						var gapX = 'grid-column-gap:' + (toGridLength(template.fQ.a) + ';');
					...
					case 9:
						...
						var msPosition = A2(
							...
							_List_fromArray(
								[
									'-ms-grid-row: ' + (elm$core$String$fromInt(position.fE) + ';'),
									'-ms-grid-row-span: ' + (elm$core$String$fromInt(position.eP) + ';'),
									'-ms-grid-column: ' + (elm$core$String$fromInt(position.ev) + ';'),
						...
						var modernPosition = A2(
							...
							_List_fromArray(
								[
									'grid-row: ' + (elm$core$String$fromInt(position.fE) + (' / ' + (elm$core$String$fromInt(position.fE + position.eP) + ';'))),
									'grid-column: ' + (elm$core$String$fromInt(position.ev) + (' / ' + (elm$core$String$fromInt(position.ev + position.dW) + ';')))
								]));
						var _class = '.grid-pos-' + (elm$core$String$fromInt(position.fE) + ('-' + (elm$core$String$fromInt(position.ev) + ('-' + (elm$core$String$fromInt(position.dW) + ('-' + elm$core$String$fromInt(position.eP)))))));
					...
					A2(
						...
						A3(
							...
							_Utils_Tuple2(
								...
								_List_fromArray(
									[
										mdgriffith$elm_ui$Internal$Model$renderFocusStyle(opts.eL)
									])),
							styles).b)),
				children)) : A2(
			elm$core$List$cons,
					...
					return A3(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										elm$html$Html$Attributes$class(mdgriffith$elm_ui$Internal$Style$classes.d9 + (' ' + mdgriffith$elm_ui$Internal$Style$classes.fM))
									]))
							]));
			}
		}();
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[mdgriffith$elm_ui$Internal$Style$classes.d9, mdgriffith$elm_ui$Internal$Style$classes.fM, mdgriffith$elm_ui$Internal$Style$classes.bw, mdgriffith$elm_ui$Internal$Style$classes.ac, mdgriffith$elm_ui$Internal$Style$classes.d6])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[mdgriffith$elm_ui$Internal$Style$classes.d9, mdgriffith$elm_ui$Internal$Style$classes.fM, mdgriffith$elm_ui$Internal$Style$classes.bw, mdgriffith$elm_ui$Internal$Style$classes.ac, mdgriffith$elm_ui$Internal$Style$classes.d4])))
						]),
					_List_fromArray(
						[html])) : html));
			case 1:
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[mdgriffith$elm_ui$Internal$Style$classes.d9, mdgriffith$elm_ui$Internal$Style$classes.fM, mdgriffith$elm_ui$Internal$Style$classes.bw, mdgriffith$elm_ui$Internal$Style$classes.d5])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[mdgriffith$elm_ui$Internal$Style$classes.d9, mdgriffith$elm_ui$Internal$Style$classes.fM, mdgriffith$elm_ui$Internal$Style$classes.bw, mdgriffith$elm_ui$Internal$Style$classes.d3])))
						]),
					_List_fromArray(
						[html])) : html));
			default:
		...
		_List_fromArray(
			[
				...
				A2(
					...
					' ',
					_List_fromArray(
						[mdgriffith$elm_ui$Internal$Style$classes.d9, mdgriffith$elm_ui$Internal$Style$classes.M, mdgriffith$elm_ui$Internal$Style$classes.cE, mdgriffith$elm_ui$Internal$Style$classes.bC])))
			]),
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				A2(
					...
					' ',
					_List_fromArray(
						[mdgriffith$elm_ui$Internal$Style$classes.d9, mdgriffith$elm_ui$Internal$Style$classes.M, mdgriffith$elm_ui$Internal$Style$classes.cF, mdgriffith$elm_ui$Internal$Style$classes.b3])))
			]),
		_List_fromArray(
			[
...
var mdgriffith$elm_ui$Internal$Model$createElement = F3(
	function (context, children, rendered) {
					...
					case 1:
						...
						return _Utils_eq(context, mdgriffith$elm_ui$Internal$Model$asParagraph) ? _Utils_Tuple2(
							A2(
								...
								_Utils_Tuple2(
									key,
									A2(styled.eT, mdgriffith$elm_ui$Internal$Model$NoStyleSheet, context)),
								htmls),
							elm$core$List$isEmpty(existingStyles) ? styled.f_ : _Utils_ap(styled.f_, existingStyles)) : _Utils_Tuple2(
							A2(
								elm$core$List$cons,
								_Utils_Tuple2(
									key,
									A2(styled.eT, mdgriffith$elm_ui$Internal$Model$NoStyleSheet, context)),
								htmls),
							elm$core$List$isEmpty(existingStyles) ? styled.f_ : _Utils_ap(styled.f_, existingStyles));
					case 2:
						var str = child.a;
						return _Utils_Tuple2(
							A2(
		...
		if (children.$ === 1) {
			...
			var keyed = _n1.a;
			var styles = _n1.b;
			var newStyles = elm$core$List$isEmpty(styles) ? rendered.f_ : _Utils_ap(rendered.f_, styles);
			if (!newStyles.b) {
						...
						switch (location) {
							case 0:
								return A2(
									...
									' ',
									_List_fromArray(
										[mdgriffith$elm_ui$Internal$Style$classes.aQ, mdgriffith$elm_ui$Internal$Style$classes.fM, mdgriffith$elm_ui$Internal$Style$classes.d_]));
							case 1:
								return A2(
									elm$core$String$join,
									' ',
									_List_fromArray(
										[mdgriffith$elm_ui$Internal$Style$classes.aQ, mdgriffith$elm_ui$Internal$Style$classes.fM, mdgriffith$elm_ui$Internal$Style$classes.eg]));
							case 2:
								return A2(
									elm$core$String$join,
									' ',
									_List_fromArray(
										[mdgriffith$elm_ui$Internal$Style$classes.aQ, mdgriffith$elm_ui$Internal$Style$classes.fM, mdgriffith$elm_ui$Internal$Style$classes.fo]));
							case 3:
								return A2(
									elm$core$String$join,
									' ',
									_List_fromArray(
										[mdgriffith$elm_ui$Internal$Style$classes.aQ, mdgriffith$elm_ui$Internal$Style$classes.fM, mdgriffith$elm_ui$Internal$Style$classes.fm]));
							case 4:
								return A2(
									elm$core$String$join,
									' ',
									_List_fromArray(
										[mdgriffith$elm_ui$Internal$Style$classes.aQ, mdgriffith$elm_ui$Internal$Style$classes.fM, mdgriffith$elm_ui$Internal$Style$classes.eW]));
							default:
								return A2(
									elm$core$String$join,
									' ',
									_List_fromArray(
										[mdgriffith$elm_ui$Internal$Style$classes.aQ, mdgriffith$elm_ui$Internal$Style$classes.fM, mdgriffith$elm_ui$Internal$Style$classes.ef]));
						}
					}())
				]),
			_List_fromArray(
				[
					...
					switch (elem.$) {
						...
						default:
							var styled = elem.a;
							return A2(styled.eT, mdgriffith$elm_ui$Internal$Model$NoStyleSheet, mdgriffith$elm_ui$Internal$Model$asEl);
					}
				}()
				]));
	});
...
var mdgriffith$elm_ui$Internal$Model$alignXName = function (align) {
	switch (align) {
		case 0:
			return mdgriffith$elm_ui$Internal$Style$classes.bV + (' ' + mdgriffith$elm_ui$Internal$Style$classes.cI);
		case 2:
			return mdgriffith$elm_ui$Internal$Style$classes.bV + (' ' + mdgriffith$elm_ui$Internal$Style$classes.cJ);
		default:
			return mdgriffith$elm_ui$Internal$Style$classes.bV + (' ' + mdgriffith$elm_ui$Internal$Style$classes.d1);
	}
};
var mdgriffith$elm_ui$Internal$Model$alignYName = function (align) {
	switch (align) {
		case 0:
			return mdgriffith$elm_ui$Internal$Style$classes.bW + (' ' + mdgriffith$elm_ui$Internal$Style$classes.d7);
		case 2:
			return mdgriffith$elm_ui$Internal$Style$classes.bW + (' ' + mdgriffith$elm_ui$Internal$Style$classes.d0);
		default:
			return mdgriffith$elm_ui$Internal$Style$classes.bW + (' ' + mdgriffith$elm_ui$Internal$Style$classes.d2);
	}
};
	...
	switch (h.$) {
		...
		case 2:
			...
			return (portion === 1) ? _Utils_Tuple3(
				...
				_List_Nil) : _Utils_Tuple3(
				A2(mdgriffith$elm_ui$Internal$Flag$add, mdgriffith$elm_ui$Internal$Flag$heightFill, mdgriffith$elm_ui$Internal$Flag$none),
				mdgriffith$elm_ui$Internal$Style$classes.c4 + (' height-fill-' + elm$core$String$fromInt(portion)),
				_List_fromArray(
					[
						A3(
						mdgriffith$elm_ui$Internal$Model$Single,
						mdgriffith$elm_ui$Internal$Style$classes.d9 + ('.' + (mdgriffith$elm_ui$Internal$Style$classes.fE + (' > ' + mdgriffith$elm_ui$Internal$Style$dot(
							...
							switch (height.$) {
								...
								case 2:
									...
									if (portion === 1) {
										...
										var $temp$classes = classes + (' ' + (mdgriffith$elm_ui$Internal$Style$classes.c4 + (' height-fill-' + elm$core$String$fromInt(portion)))),
											$temp$node = node,
											$temp$has = A2(
											mdgriffith$elm_ui$Internal$Flag$add,
											mdgriffith$elm_ui$Internal$Flag$heightFill,
											...
											A3(
												mdgriffith$elm_ui$Internal$Model$Single,
												mdgriffith$elm_ui$Internal$Style$classes.d9 + ('.' + (mdgriffith$elm_ui$Internal$Style$classes.ex + (' > ' + mdgriffith$elm_ui$Internal$Style$dot(
													'height-fill-' + elm$core$String$fromInt(portion))))),
												'flex-grow',
												elm$core$String$fromInt(portion * 100000)),
											styles),
					...
					case 9:
						...
						var newStyles = function () {
							switch (elem.$) {
								...
								default:
									var styled = elem.a;
									return _Utils_ap(styles, styled.f_);
							}
						}();
						var $temp$classes = classes,
							$temp$node = node,
...
var author$project$Guide$Text$fontSize = F3(
	function (screenClass, location, kind) {
		if (screenClass === 1) {
			var _n1 = _Utils_Tuple2(location, kind);
			switch (_n1.a) {
				case 0:
					if (!_n1.b) {
						var _n2 = _n1.a;
			...
			var _n21 = _Utils_Tuple2(location, kind);
			switch (_n21.a) {
				case 0:
					if (!_n21.b) {
						var _n22 = _n21.a;
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					{cN: 0, da: leftPadding, dz: rightPadding, dN: 0})
				]),
			function () {
...
var mdgriffith$elm_ui$Element$scrollbarX = A2(mdgriffith$elm_ui$Internal$Model$Class, mdgriffith$elm_ui$Internal$Flag$overflow, mdgriffith$elm_ui$Internal$Style$classes.fH);
...
var author$project$Guide$Document$codeBlockAttributes = function (_n0) {
	var screenClass = _n0.K;
	return _List_fromArray(
		[
				...
				A2(
					...
					A2(
						...
						A2(
							...
							A2(
								elm$core$List$cons,
								mdgriffith$elm_ui$Internal$Model$htmlClass(mdgriffith$elm_ui$Internal$Style$classes.by + (' ' + mdgriffith$elm_ui$Internal$Style$classes.ac)),
								attrs))))),
			mdgriffith$elm_ui$Internal$Model$Unkeyed(
				_List_fromArray(
					[label])));
...
var author$project$Guide$Document$documentationLink = F4(
	function (config, moduleName, memberName, fullString) {
		return A2(
			...
			{
				b4: mdgriffith$elm_ui$Element$text(fullString),
				aG: A4(
...
var author$project$Guide$Document$viewModule = F2(
	function (config, name) {
		return A2(elm$core$Set$member, name, config.ba) ? A4(author$project$Guide$Document$documentationLink, config, name, elm$core$Maybe$Nothing, name) : A2(author$project$Guide$Document$viewColoredChunk, author$project$Guide$Color$black, name);
	});
var author$project$Guide$Document$viewModuleMember = F3(
	function (config, _n0, fullString) {
		var moduleName = _n0.fg;
		var memberName = _n0.fc;
		return A2(elm$core$Set$member, moduleName, config.ba) ? A4(
...
var mdgriffith$elm_ui$Element$row = F2(
	function (attrs, children) {
		return A4(
			...
			A2(
				elm$core$List$cons,
				mdgriffith$elm_ui$Internal$Model$htmlClass(mdgriffith$elm_ui$Internal$Style$classes.a0 + (' ' + mdgriffith$elm_ui$Internal$Style$classes.ac)),
				A2(
					elm$core$List$cons,
					mdgriffith$elm_ui$Element$width(mdgriffith$elm_ui$Element$shrink),
					A2(
...
var mdgriffith$elm_ui$Element$column = F2(
	function (attrs, children) {
		return A4(
			...
			A2(
				elm$core$List$cons,
				mdgriffith$elm_ui$Internal$Model$htmlClass(mdgriffith$elm_ui$Internal$Style$classes.ey + (' ' + mdgriffith$elm_ui$Internal$Style$classes.a0)),
				A2(
					elm$core$List$cons,
					mdgriffith$elm_ui$Element$height(mdgriffith$elm_ui$Element$shrink),
					A2(
...
var mdgriffith$elm_ui$Element$Font$italic = mdgriffith$elm_ui$Internal$Model$htmlClass(mdgriffith$elm_ui$Internal$Style$classes.e4);
		...
		switch (fragment.$) {
			...
			case 2:
				...
				return A2(
					...
					mdgriffith$elm_ui$Element$text(string));
			case 4:
				var url = fragment.a.aG;
				var displayed = fragment.a.b_;
				var _n1 = function () {
					switch (displayed.$) {
						case 0:
							...
							return _Utils_Tuple2(
								A2(
									...
									A2(
										elm$core$List$cons,
										mdgriffith$elm_ui$Element$Font$size(
											A3(author$project$Guide$Text$fontSize, config.K, textLocation, 1)),
			...
			case 3:
				...
				var codeFontSize = A3(author$project$Guide$Text$fontSize, config.K, textLocation, 1);
				return A2(
					mdgriffith$elm_ui$Element$row,
					A2(
						elm$core$List$cons,
...
var author$project$Guide$Document$viewParagraph = F2(
	function (config, textFragments) {
		return A2(
			...
			_List_fromArray(
				[
					A2(author$project$Guide$Text$lineSpacing, config.K, 3)
				]),
	...
	while (true) {
		switch (textFragment.$) {
			...
			case 2:
				...
				return string;
			case 4:
				var displayed = textFragment.a.b_;
			...
			case 3:
				...
				return elm$core$String$concat(
					A2(elm$core$List$map, author$project$Guide$Document$inlineCodeChunkToString, chunks));
			default:
				var description = textFragment.a.cX;
				return description;
		}
	}
};
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					mdgriffith$elm_ui$Element$Font$size(
					A3(author$project$Guide$Text$fontSize, config.K, 2, 0)),
					A2(author$project$Guide$Text$lineSpacing, config.K, 2),
					mdgriffith$elm_ui$Element$htmlAttribute(
					elm$html$Html$Attributes$id(
						author$project$Guide$Document$toId(textFragments)))
				]),
...
var ianmackenzie$elm_geometry$BoundingBox2d$fromExtrema = function (extrema_) {
	return ((_Utils_cmp(extrema_.fd, extrema_.fa) < 1) && (_Utils_cmp(extrema_.fe, extrema_.fb) < 1)) ? extrema_ : {
		fa: A2(elm$core$Basics$max, extrema_.fd, extrema_.fa),
		fb: A2(elm$core$Basics$max, extrema_.fe, extrema_.fb),
		fd: A2(elm$core$Basics$min, extrema_.fd, extrema_.fa),
		fe: A2(elm$core$Basics$min, extrema_.fe, extrema_.fb)
	};
};
		...
		function (bottomY, topY) {
			return A2(
				...
				ianmackenzie$elm_geometry$BoundingBox2d$fromExtrema(
					{fa: 18, fb: height - bottomY, fd: 2, fe: height - topY}));
		});
	return mdgriffith$elm_ui$Element$html(
		A2(
			elm$svg$Svg$svg,
					...
					[
						...
						_List_fromArray(
							[
								...
								mdgriffith$elm_ui$Element$Font$size(
								A3(author$project$Guide$Text$fontSize, config.K, 0, 0)),
								A2(author$project$Guide$Text$lineSpacing, config.K, 0),
								mdgriffith$elm_ui$Element$width(mdgriffith$elm_ui$Element$fill)
							]),
						...
						if (!_n1) {
							return A2(
								...
								{b4: author$project$Guide$Document$hamburgerIcon, aG: config.fD});
						} else {
							...
							[
								...
								_List_fromArray(
									[
										...
										mdgriffith$elm_ui$Element$Font$italic,
										mdgriffith$elm_ui$Element$Font$size(
										A3(author$project$Guide$Text$fontSize, config.K, 3, 0))
									]),
								_List_fromArray(
									[
...
var author$project$Guide$Document$view = F3(
	function (config, givenAttributes, _n0) {
		var document = _n0;
			...
			if (!internalMessage.$) {
				...
				return author$project$Guide$Document$Updated(
					_Utils_update(
						document,
						{
							bt: A3(author$project$Guide$Document$updateWidget, id, widget, document.bt)
						}));
			} else {
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					toMsg,
					A2(author$project$Guide$Document$viewTitle, config, document.dM)),
					author$project$Guide$Document$spacer(20),
					A2(
					mdgriffith$elm_ui$Element$map,
					toMsg,
					A3(author$project$Guide$Document$viewChunks, config, 0, document.bt)),
					bottomSpacer
				]));
	});
...
var author$project$Guide$viewDocument = F4(
	function (model, attributes, loadedDocument, lastModified) {
		var documentConfig = {
			...
			ba: model.ba,
			W: model.W,
			fD: author$project$Guide$appendSlash(
				A2(elm$url$Url$Builder$absolute, model.aV, _List_Nil)),
			K: model.K
		};
		return A2(
			mdgriffith$elm_ui$Element$map,
			...
			_List_fromArray(
				[
					...
					mdgriffith$elm_ui$Element$px(
						A3(author$project$Guide$Text$fontSize, model.K, 6, 0)))
				]),
			properties);
	});
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				model,
				{cX: 'GitHub logo', dE: 'images/github.svg'}),
				A2(
				mdgriffith$elm_ui$Element$link,
				_List_Nil,
				{
					b4: mdgriffith$elm_ui$Element$text('Source code'),
					aG: A3(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				author$project$Guide$navIcon,
				model,
				{cX: 'Elm logo', dE: 'images/elm.svg'}),
				A2(
				mdgriffith$elm_ui$Element$link,
				_List_Nil,
				{
					b4: mdgriffith$elm_ui$Element$text('API documentation'),
					aG: A3(
						elm$url$Url$Builder$crossOrigin,
						'https://package.elm-lang.org',
						_List_fromArray(
							['packages', model.an, model.W, 'latest']),
						_List_Nil)
				})
			]));
};
		...
		return A2(
			...
			attributes,
			{
				b4: mdgriffith$elm_ui$Element$text(
					author$project$Guide$Page$title(page)),
				aG: A3(author$project$Guide$Page$displayedUrl, rootPath, page, elm$core$Maybe$Nothing)
			});
	});
var author$project$Guide$Color$navTitle = author$project$Guide$Color$grey;
var author$project$Guide$Text$NavTitle = 5;
var mdgriffith$elm_ui$Element$clipY = A2(mdgriffith$elm_ui$Internal$Model$Class, mdgriffith$elm_ui$Internal$Flag$overflow, mdgriffith$elm_ui$Internal$Style$classes.eu);
...
var mdgriffith$elm_ui$Element$scrollbarY = A2(mdgriffith$elm_ui$Internal$Model$Class, mdgriffith$elm_ui$Internal$Flag$overflow, mdgriffith$elm_ui$Internal$Style$classes.fI);
var mdgriffith$elm_ui$Element$Font$regular = A2(mdgriffith$elm_ui$Internal$Model$Class, mdgriffith$elm_ui$Internal$Flag$fontWeight, mdgriffith$elm_ui$Internal$Style$classes.f9);
		...
		var titleElement = A2(
			...
			_List_fromArray(
				[
					...
					mdgriffith$elm_ui$Element$Font$size(
					A3(author$project$Guide$Text$fontSize, model.K, 5, 0))
				]),
			_List_fromArray(
				[
			...
			elm$core$List$concat(
				_List_fromArray(
					[
						...
						A2(
						elm$core$List$map,
						A2(author$project$Guide$toPageLink, model.aV, currentPage),
						model.bn),
						_List_fromArray(
						[author$project$Guide$horizontalDivider]),
						_List_fromArray(
...
var mdgriffith$elm_ui$Internal$Model$optionsToRecord = function (options) {
				...
				case 0:
					...
					if (_n4.$ === 1) {
						return _Utils_update(
							record,
							{
								eS: elm$core$Maybe$Just(hoverable)
							});
					} else {
						return record;
					}
				case 1:
					...
					if (_n5.$ === 1) {
						return _Utils_update(
							record,
							{
								eL: elm$core$Maybe$Just(focusStyle)
							});
					} else {
						return record;
					}
	...
	return andFinally(
		A3(
			elm$core$List$foldr,
			combine,
			{eL: elm$core$Maybe$Nothing, eS: elm$core$Maybe$Nothing, ff: elm$core$Maybe$Nothing},
			options));
};
			...
			A2(
				...
				mdgriffith$elm_ui$Internal$Model$htmlClass(
					A2(
						...
						' ',
						_List_fromArray(
							[mdgriffith$elm_ui$Internal$Style$classes.fC, mdgriffith$elm_ui$Internal$Style$classes.d9, mdgriffith$elm_ui$Internal$Style$classes.fM]))),
				...
				if (_n0 === 1) {
					var documentElement = function () {
						...
						switch (_n2.$) {
							...
							case 1:
								return mdgriffith$elm_ui$Element$none;
							case 3:
								var document = _n2.a.bA;
								var lastModified = _n2.a.aP;
								return A4(
					...
					var displayedPage = function () {
						...
						switch (_n1.$) {
							...
							case 0:
								return elm$core$Maybe$Just(model.bM);
							case 1:
								return elm$core$Maybe$Nothing;
							default:
								return elm$core$Maybe$Nothing;
						...
						function () {
							...
							switch (_n3.$) {
								...
								case 1:
									return mdgriffith$elm_ui$Element$none;
								case 3:
									var document = _n3.a.bA;
									var lastModified = _n3.a.aP;
									return A4(
										author$project$Guide$viewDocument,
										model,
										_List_fromArray(
...
var author$project$Guide$Page$with = function (given) {
	return author$project$Guide$Page$Page(
		{
			dL: given.dL,
			bm: elm$core$Dict$fromList(given.bm)
		});
};
...
var author$project$Guide$program = function (_n0) {
	...
	return elm$browser$Browser$application(
		{
			e_: A5(author$project$Guide$init, author, packageName, widgets, readmePage, allPages),
			fp: author$project$Guide$UrlChanged,
			fq: author$project$Guide$UrlRequested,
			f0: elm$core$Basics$always(elm$core$Platform$Sub$none),
			gh: author$project$Guide$update,
			gi: author$project$Guide$view
		});
};
var author$project$Main$main = author$project$Guide$program(
	{
		an: 'ianmackenzie',
		eo: 'coordinate-systems',
		W: 'elm-geometry',
		ft: _List_fromArray(
