...
{
	if (region.fw.aY === region.eo.aY)
	{
		return 'on line ' + region.fw.aY;
	}
	return 'on lines ' + region.fw.aY + ' through ' + region.eo.aY;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { ey: 'hidden', d9: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { ey: 'mozHidden', d9: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { ey: 'msHidden', d9: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { ey: 'webkitHidden', d9: 'webkitvisibilitychange' }
		: { ey: 'hidden', d9: 'visibilitychange' };
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		try {
			xhr.open(request.eS, request.aA, true);
		} catch (e) {
		...
		request.d_.a && xhr.setRequestHeader('Content-Type', request.d_.a);
		xhr.send(request.d_.b);
		...
		while (true) {
			if (fromIndex < 0) {
				return A2(
					...
					false,
					{y: nodeList, u: (len / $elm$core$Array$branchFactor) | 0, x: tail});
			} else {
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {as: fragment, cJ: host, e6: path, c1: port_, c5: protocol, c6: query};
	});
...
var $author$project$Guide$DocsJsonResponse = function (a) {
	return {$: 5, a: a};
};
var $author$project$Guide$Loading = {$: 1};
...
var $elm$project_metadata_utils$Elm$Docs$Module = F6(
	function (name, comment, unions, aliases, values, binops) {
		return {aR: aliases, co: binops, aD: comment, eW: name, a5: unions, dw: values};
	});
var $elm$project_metadata_utils$Elm$Docs$Alias = F4(
	function (name, comment, args, tipe) {
		return {_: args, aD: comment, eW: name, a2: tipe};
	});
var $elm$json$Json$Decode$fail = _Json_fail;
var $elm$parser$Parser$DeadEnd = F3(
	function (row, col, problem) {
		return {ed: col, c2: problem, fh: row};
	});
var $elm$parser$Parser$problemToDeadEnd = function (p) {
	return A3($elm$parser$Parser$DeadEnd, p.fh, p.ed, p.c2);
};
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{ed: 1, i: _List_Nil, r: 1, c: 0, fh: 1, dj: src});
		if (!_v1.$) {
			var value = _v1.b;
...
var $elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {ed: col, eh: contextStack, c2: problem, fh: row};
	});
...
var $elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4($elm$parser$Parser$Advanced$DeadEnd, s.fh, s.ed, x, s.i));
	});
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.c, s.fh, s.ed, s.dj);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			progress,
			0,
			{ed: newCol, i: s.i, r: s.r, c: newOffset, fh: newRow, dj: s.dj});
	};
};
	...
	function (isGood, offset, row, col, src, indent, context) {
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return {ed: col, i: context, r: indent, c: offset, fh: row, dj: src};
			} else {
...
var $elm$parser$Parser$Advanced$variable = function (i) {
	return function (s) {
		var firstOffset = A3($elm$parser$Parser$Advanced$isSubChar, i.fw, s.c, s.dj);
		if (_Utils_eq(firstOffset, -1)) {
			...
			var s1 = _Utils_eq(firstOffset, -2) ? A7($elm$parser$Parser$Advanced$varHelp, i.eG, s.c + 1, s.fh + 1, 1, s.dj, s.r, s.i) : A7($elm$parser$Parser$Advanced$varHelp, i.eG, firstOffset, s.fh, s.ed + 1, s.dj, s.r, s.i);
			var name = A3($elm$core$String$slice, s.c, s1.c, s.dj);
			return A2($elm$core$Set$member, name, i.fd) ? A2(
				$elm$parser$Parser$Advanced$Bad,
				false,
...
var $elm$parser$Parser$variable = function (i) {
	return $elm$parser$Parser$Advanced$variable(
		{cE: $elm$parser$Parser$ExpectingVariable, eG: i.eG, fd: i.fd, fw: i.fw});
};
var $elm$project_metadata_utils$Elm$Type$var = function (isFirst) {
	return $elm$parser$Parser$variable(
		{eG: $elm$project_metadata_utils$Elm$Type$isInnerVarChar, fd: $elm$core$Set$empty, fw: isFirst});
};
...
var $elm$parser$Parser$Advanced$chompWhileHelp = F5(
	function (isGood, offset, row, col, s0) {
		chompWhileHelp:
		while (true) {
			var newOffset = A3($elm$parser$Parser$Advanced$isSubChar, isGood, offset, s0.dj);
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					$elm$parser$Parser$Advanced$Good,
					_Utils_cmp(s0.c, offset) < 0,
					0,
					{ed: col, i: s0.i, r: s0.r, c: offset, fh: row, dj: s0.dj});
			} else {
				if (_Utils_eq(newOffset, -2)) {
					var $temp$isGood = isGood,
						$temp$offset = offset + 1,
...
var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.c, s.fh, s.ed, s);
	};
};
		...
		return function (s0) {
			...
			if (_v1.$ === 1) {
				...
				return A3(
					...
					A2(
						func,
						A3($elm$core$String$slice, s0.c, s1.c, s0.dj),
						a),
					s1);
			}
		};
...
var $elm$parser$Parser$Advanced$sequence = function (i) {
	return A2(
		$elm$parser$Parser$Advanced$skip,
		$elm$parser$Parser$Advanced$token(i.fw),
		A2(
			$elm$parser$Parser$Advanced$skip,
			i.di,
			A5(
				$elm$parser$Parser$Advanced$sequenceEnd,
				$elm$parser$Parser$Advanced$token(i.eo),
				i.di,
				i.cM,
				$elm$parser$Parser$Advanced$token(i.de),
				i.du)));
};
...
var $elm$parser$Parser$sequence = function (i) {
	return $elm$parser$Parser$Advanced$sequence(
		{
			eo: $elm$parser$Parser$toToken(i.eo),
			cM: i.cM,
			de: $elm$parser$Parser$toToken(i.de),
			di: i.di,
			fw: $elm$parser$Parser$toToken(i.fw),
			du: $elm$parser$Parser$toAdvancedTrailing(i.du)
		});
};
...
function $elm$project_metadata_utils$Elm$Type$cyclic$tuple() {
	return A2(
		...
		$elm$parser$Parser$sequence(
			{
				eo: ')',
				cM: $elm$project_metadata_utils$Elm$Type$cyclic$tipe(),
				de: ',',
				di: $elm$project_metadata_utils$Elm$Type$spaces,
				fw: '(',
				du: 0
			}));
}
...
var $elm$project_metadata_utils$Elm$Docs$Binop = F5(
	function (name, comment, tipe, associativity, precedence) {
		return {dU: associativity, aD: comment, eW: name, e8: precedence, a2: tipe};
	});
...
var $elm$project_metadata_utils$Elm$Docs$Union = F4(
	function (name, comment, args, tags) {
		return {_: args, aD: comment, eW: name, a1: tags};
	});
...
var $elm$project_metadata_utils$Elm$Docs$Value = F3(
	function (name, comment, tipe) {
		return {aD: comment, eW: name, a2: tipe};
	});
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{dQ: false, d_: r.d_, cD: r.cD, ev: r.ev, eS: r.eS, fU: r.fU, dt: r.dt, aA: r.aA}));
};
var $elm$http$Http$get = function (r) {
	return $elm$http$Http$request(
		{d_: $elm$http$Http$emptyBody, cD: r.cD, ev: _List_Nil, eS: 'GET', fU: $elm$core$Maybe$Nothing, dt: $elm$core$Maybe$Nothing, aA: r.aA});
};
var $author$project$Guide$Error = function (a) {
	return {$: 2, a: a};
};
var $author$project$Guide$Navigating = {$: 0};
var $author$project$Guide$Page$isReadme = function (page) {
	if (!page.$) {
		return true;
	} else {
		return false;
...
var $author$project$Guide$DocumentLoaded = function (a) {
	return {$: 3, a: a};
};
...
var $pablohirafuji$elm_markdown$Markdown$Block$query = F2(
	function (_function, block) {
		switch (block.$) {
			case 5:
				...
				return _Utils_ap(
					_function(
						$pablohirafuji$elm_markdown$Markdown$Block$BlockQuote(blocks)),
					$elm$core$List$concat(
						A2(
							$elm$core$List$map,
							$pablohirafuji$elm_markdown$Markdown$Block$query(_function),
							blocks)));
			case 6:
				...
				return _Utils_ap(
					_function(
						A2($pablohirafuji$elm_markdown$Markdown$Block$List, listBlock, items)),
					$elm$core$List$concat(
						$elm$core$List$concat(
							A2(
								$elm$core$List$map,
			...
			case 8:
				...
				return _Utils_ap(
					_function(
						A2($pablohirafuji$elm_markdown$Markdown$Block$Custom, customBlock, blocks)),
					$elm$core$List$concat(
						A2(
							$elm$core$List$map,
							$pablohirafuji$elm_markdown$Markdown$Block$query(_function),
...
var $pablohirafuji$elm_markdown$Markdown$InlineParser$query = F2(
	function (_function, inline) {
		switch (inline.$) {
			case 3:
				...
				return _Utils_ap(
					_function(
						A3($pablohirafuji$elm_markdown$Markdown$Inline$Link, url, maybeTitle, inlines)),
					$elm$core$List$concat(
						A2(
							$elm$core$List$map,
							$pablohirafuji$elm_markdown$Markdown$InlineParser$query(_function),
							inlines)));
			case 4:
				var url = inline.a;
				var maybeTitle = inline.b;
				...
				return _Utils_ap(
					_function(
						A3($pablohirafuji$elm_markdown$Markdown$Inline$Image, url, maybeTitle, inlines)),
					$elm$core$List$concat(
						A2(
							$elm$core$List$map,
							$pablohirafuji$elm_markdown$Markdown$InlineParser$query(_function),
			...
			case 5:
				...
				return _Utils_ap(
					_function(
						A3($pablohirafuji$elm_markdown$Markdown$Inline$HtmlInline, tag, attrs, inlines)),
					$elm$core$List$concat(
						A2(
							$elm$core$List$map,
							$pablohirafuji$elm_markdown$Markdown$InlineParser$query(_function),
			...
			case 6:
				...
				return _Utils_ap(
					_function(
						A2($pablohirafuji$elm_markdown$Markdown$Inline$Emphasis, length, inlines)),
					$elm$core$List$concat(
						A2(
							$elm$core$List$map,
							$pablohirafuji$elm_markdown$Markdown$InlineParser$query(_function),
...
var $pablohirafuji$elm_markdown$Markdown$Block$queryInlinesHelp = F2(
	function (_function, block) {
		switch (block.$) {
			case 4:
				var inlines = block.b;
...
var $pablohirafuji$elm_markdown$Markdown$Block$queryInlines = F2(
	function (_function, block) {
		return A2(
			$pablohirafuji$elm_markdown$Markdown$Block$query,
			$pablohirafuji$elm_markdown$Markdown$Block$queryInlinesHelp(_function),
			block);
	});
var $author$project$Guide$Document$collectImageUrls = function (blocks) {
	return $elm$core$Set$fromList(
		$elm$core$List$concat(
			A2(
				$elm$core$List$map,
				$pablohirafuji$elm_markdown$Markdown$Block$queryInlines($author$project$Guide$Document$getImageUrls),
				blocks)));
};
...
var $elm$regex$Regex$Match = F4(
	function (match, index, number, submatches) {
		return {eE: index, eO: match, eX: number, fE: submatches};
	});
...
var $pablohirafuji$elm_markdown$Markdown$Block$calcListIndentLength = function (_v0) {
	...
	var indentLength = (isIndentedCode || A2($elm$regex$Regex$contains, $pablohirafuji$elm_markdown$Markdown$Block$blankLineRegex, rawLine)) ? (listBlock.A - indentSpaceLength) : listBlock.A;
	...
	if (((_v0.b && _v0.b.b) && (!_v0.b.a.$)) && _v0.b.b.b) {
		...
		return $elm$core$Maybe$Just(
			A2(
				...
				true,
				{
					bG: A2($elm$core$String$left, 1, fence),
					bH: $elm$core$String$length(fence),
					A: A2(
						$elm$core$Maybe$withDefault,
						0,
	...
	if (((((((_v0.b && (!_v0.a.$)) && _v0.b.b) && (!_v0.b.a.$)) && _v0.b.b.b) && (!_v0.b.b.a.$)) && _v0.b.b.b.b) && _v0.b.b.b.b.b) {
		...
		return $elm$core$Maybe$Just(
			_Utils_Tuple3(
				{
					aT: delimiter,
					A: $elm$core$String$length(indentString) + 1,
					ac: false,
					fX: A2(
						$elm$core$Maybe$withDefault,
			...
			_Utils_Tuple3(
				{
					...
					A: $elm$core$String$length(indentString) + 1,
					ac: false,
					fX: $pablohirafuji$elm_markdown$Markdown$Block$Unordered
				},
				A2($elm$core$Maybe$withDefault, '', maybeIndentSpace),
				A2($elm$core$Maybe$withDefault, '', maybeRawLine)));
	} else {
...
var $pablohirafuji$elm_markdown$Markdown$Block$continueOrCloseCodeFence = F3(
	function (fence, previousCode, rawLine) {
		return A2($pablohirafuji$elm_markdown$Markdown$Block$isCloseFenceLine, fence, rawLine) ? A2(
			...
			$pablohirafuji$elm_markdown$Markdown$Block$CodeBlock,
			A2($pablohirafuji$elm_markdown$Markdown$Block$Fenced, true, fence),
			previousCode + (A2($pablohirafuji$elm_markdown$Markdown$Helpers$indentLine, fence.A, rawLine) + '\n'));
	});
				...
				switch (ast.a.$) {
					...
					case 6:
						...
						return (_Utils_cmp(
							...
							model.A) > -1) ? A5($pablohirafuji$elm_markdown$Markdown$Block$parseIndentedListLine, rawLine, model, items, ast, astTail) : A2(
				...
				A2(
					...
					function (a) {
						...
						function (a) {
							...
							A2($pablohirafuji$elm_markdown$Markdown$Helpers$indentLine, model.A, rawLine)))));
		} else {
			var item = items.a;
			var itemsTail = items.b;
			var indentedRawLine = A2($pablohirafuji$elm_markdown$Markdown$Helpers$indentLine, model.A, rawLine);
					...
					switch (item.a.$) {
						...
						case 6:
							...
							return (_Utils_cmp(
								...
								model_.A) > -1) ? updateList(model) : ($pablohirafuji$elm_markdown$Markdown$Block$isBlankLineLast(items_) ? updateList(
								_Utils_update(
									model,
									{ac: true})) : updateList(model));
						default:
							break _v7$3;
					}
				} else {
						...
						return _Utils_eq(listBlock.aT, model.aT) ? function (a) {
							...
							A2(
								...
								_Utils_update(
									...
									{
										A: listBlock.A,
										ac: model.ac || $pablohirafuji$elm_markdown$Markdown$Block$isBlankLineLast(items)
									}),
...
var $pablohirafuji$elm_markdown$Markdown$Config$defaultOptions = {
	fa: $pablohirafuji$elm_markdown$Markdown$Config$Sanitize($pablohirafuji$elm_markdown$Markdown$Config$defaultSanitizeOptions),
	fr: false
};
var $pablohirafuji$elm_markdown$Markdown$InlineParser$initParser = F3(
	function (options, refs, rawText) {
		return {d: _List_Nil, cY: options, D: rawText, b9: refs, s: _List_Nil};
	});
...
var $pablohirafuji$elm_markdown$Markdown$InlineParser$matchToInline = function (_v0) {
	...
	switch (_v1.$) {
		case 0:
			return $pablohirafuji$elm_markdown$Markdown$Inline$Text(match.P);
		case 1:
			return $pablohirafuji$elm_markdown$Markdown$Inline$HardLineBreak;
		case 2:
			return $pablohirafuji$elm_markdown$Markdown$Inline$CodeInline(match.P);
		case 3:
			var _v2 = _v1.a;
			var text = _v2.a;
			var url = _v2.b;
...
var $pablohirafuji$elm_markdown$Markdown$InlineParser$prepareChildMatch = F2(
	function (parentMatch, childMatch) {
		return _Utils_update(
			childMatch,
			{eo: childMatch.eo - parentMatch.R, fw: childMatch.fw - parentMatch.R, aP: childMatch.aP - parentMatch.R, R: childMatch.R - parentMatch.R});
	});
...
var $pablohirafuji$elm_markdown$Markdown$InlineParser$organizeMatch = F2(
	function (_v0, matches) {
		...
		if (!matches.b) {
			...
			return (_Utils_cmp(prevMatch.eo, match.fw) < 1) ? A2($elm$core$List$cons, match, matches) : (((_Utils_cmp(prevMatch.fw, match.fw) < 0) && (_Utils_cmp(prevMatch.eo, match.eo) > 0)) ? A2(
				$elm$core$List$cons,
...
var $pablohirafuji$elm_markdown$Markdown$InlineParser$normalMatch = function (text) {
	return {
		...
		d: _List_Nil,
		fw: 0,
		P: $pablohirafuji$elm_markdown$Markdown$Helpers$formatStr(text),
		aP: 0,
		R: 0,
		fX: $pablohirafuji$elm_markdown$Markdown$InlineParser$NormalType
	};
};
var $pablohirafuji$elm_markdown$Markdown$InlineParser$parseTextMatch = F3(
	function (rawText, _v2, parsedMatches) {
		...
		var updtMatch = _Utils_update(
			matchModel,
			{
				d: A3($pablohirafuji$elm_markdown$Markdown$InlineParser$parseTextMatches, matchModel.P, _List_Nil, matchModel.d)
			});
		if (!parsedMatches.b) {
			var finalStr = A2($elm$core$String$dropLeft, matchModel.eo, rawText);
			...
			return _Utils_eq(matchHead.fX, $pablohirafuji$elm_markdown$Markdown$InlineParser$NormalType) ? A2($elm$core$List$cons, updtMatch, parsedMatches) : (_Utils_eq(matchModel.eo, matchHead.fw) ? A2($elm$core$List$cons, updtMatch, parsedMatches) : ((_Utils_cmp(matchModel.eo, matchHead.fw) < 0) ? A2(
				$elm$core$List$cons,
				updtMatch,
				A2(
					$elm$core$List$cons,
					$pablohirafuji$elm_markdown$Markdown$InlineParser$normalMatch(
						A3($elm$core$String$slice, matchModel.eo, matchHead.fw, rawText)),
		...
		while (true) {
			if (!matches.b) {
				if (!parsedMatches.b) {
					...
					return (matchModel.fw > 0) ? A2(
						$elm$core$List$cons,
						$pablohirafuji$elm_markdown$Markdown$InlineParser$normalMatch(
							A2($elm$core$String$left, matchModel.fw, rawText)),
						parsedMatches) : parsedMatches;
				}
			} else {
				var match = matches.a;
...
var $pablohirafuji$elm_markdown$Markdown$InlineParser$parseText = function (model) {
	return _Utils_update(
		model,
		{
			d: A3($pablohirafuji$elm_markdown$Markdown$InlineParser$parseTextMatches, model.D, _List_Nil, model.d)
		});
};
...
var $pablohirafuji$elm_markdown$Markdown$InlineParser$regMatchToAngleBracketLToken = function (regMatch) {
	...
	if ((_v0.b && _v0.b.b) && (!_v0.b.a.$)) {
		...
		return $pablohirafuji$elm_markdown$Markdown$Helpers$isEven(backslashesLength) ? $elm$core$Maybe$Just(
			{
				eE: regMatch.eE + backslashesLength,
				e: 1,
...
var $pablohirafuji$elm_markdown$Markdown$InlineParser$regMatchToEmphasisToken = F3(
	function (_char, rawText, regMatch) {
		...
		if ((((_v0.b && _v0.b.b) && _v0.b.b.b) && (!_v0.b.b.a.$)) && _v0.b.b.b.b) {
			...
			var mLeftFringe = ((!(!regMatch.eE)) && (!leftFringeLength)) ? $elm$core$Maybe$Just(
				A3($elm$core$String$slice, regMatch.eE - 1, regMatch.eE, rawText)) : maybeLeftFringe;
			var backslashesLength = A2(
				$elm$core$Maybe$withDefault,
				0,
				A2($elm$core$Maybe$map, $elm$core$String$length, maybeBackslashes));
			...
			var index = ((regMatch.eE + backslashesLength) + leftFringeLength) + (isEscaped ? 1 : 0);
...
var $pablohirafuji$elm_markdown$Markdown$InlineParser$regMatchToCodeToken = function (regMatch) {
	...
	if ((_v0.b && _v0.b.b) && (!_v0.b.a.$)) {
		...
		return $elm$core$Maybe$Just(
			{
				eE: regMatch.eE + backslashesLength,
				e: $elm$core$String$length(backtick),
	...
	while (true) {
		if (_v0.b) {
			if (!_v0.a.$) {
				...
				return (!$pablohirafuji$elm_markdown$Markdown$Helpers$isEven(backslashesLength)) ? $elm$core$Maybe$Just(
					{eE: (regMatch.eE + backslashesLength) - 1, e: 2, j: $pablohirafuji$elm_markdown$Markdown$InlineParser$HardLineBreakToken}) : $elm$core$Maybe$Nothing;
			} else {
				if (_v0.b.b && (!_v0.b.a.$)) {
					var _v1 = _v0.b;
					return $elm$core$Maybe$Just(
						{
							eE: regMatch.eE,
							e: $elm$core$String$length(regMatch.eO),
	...
	while (true) {
		if (_v0.b) {
			if (!_v0.a.$) {
				...
				var backslashesLength = $elm$core$String$length(backslashes);
				return $pablohirafuji$elm_markdown$Markdown$Helpers$isEven(backslashesLength) ? $elm$core$Maybe$Just(
					{eE: regMatch.eE + backslashesLength, e: 1, j: $pablohirafuji$elm_markdown$Markdown$InlineParser$HardLineBreakToken}) : $elm$core$Maybe$Just(
					{eE: (regMatch.eE + backslashesLength) - 1, e: 2, j: $pablohirafuji$elm_markdown$Markdown$InlineParser$HardLineBreakToken});
			} else {
				if (_v0.b.b) {
					var _v1 = _v0.b;
...
var $pablohirafuji$elm_markdown$Markdown$InlineParser$regMatchToLinkImageOpenToken = function (regMatch) {
	...
	if (((_v0.b && _v0.b.b) && _v0.b.b.b) && (!_v0.b.b.a.$)) {
		...
		var index = (regMatch.eE + backslashesLength) + ((isEscaped && _Utils_eq(
			maybeImageOpen,
	...
	return _Utils_update(
		model,
		{
			s: A2(
				...
				_Utils_ap(
					$pablohirafuji$elm_markdown$Markdown$InlineParser$findAngleBracketRTokens(model.D),
					_Utils_ap(
						$pablohirafuji$elm_markdown$Markdown$InlineParser$findAngleBracketLTokens(model.D),
						_Utils_ap(
							A2($pablohirafuji$elm_markdown$Markdown$InlineParser$findHardBreakTokens, model.cY.fr, model.D),
							_Utils_ap(
								$pablohirafuji$elm_markdown$Markdown$InlineParser$findLinkImageCloseTokens(model.D),
								_Utils_ap(
									$pablohirafuji$elm_markdown$Markdown$InlineParser$findLinkImageOpenTokens(model.D),
									_Utils_ap(
										$pablohirafuji$elm_markdown$Markdown$InlineParser$findUnderlineEmphasisTokens(model.D),
										_Utils_ap(
											$pablohirafuji$elm_markdown$Markdown$InlineParser$findAsteriskEmphasisTokens(model.D),
											$pablohirafuji$elm_markdown$Markdown$InlineParser$findCodeTokens(model.D)))))))))
		});
};
...
var $pablohirafuji$elm_markdown$Markdown$InlineParser$addToken = F2(
	function (model, token) {
		return _Utils_update(
			model,
			{
				s: A2($elm$core$List$cons, token, model.s)
			});
	});
...
var $pablohirafuji$elm_markdown$Markdown$InlineParser$autolinkToMatch = function (_v0) {
	var match = _v0;
	return A2($elm$regex$Regex$contains, $pablohirafuji$elm_markdown$Markdown$InlineParser$urlRegex, match.P) ? $elm$core$Result$Ok(
		_Utils_update(
			match,
			{
				fX: $pablohirafuji$elm_markdown$Markdown$InlineParser$AutolinkType(
					_Utils_Tuple2(
						match.P,
						$pablohirafuji$elm_markdown$Markdown$InlineParser$encodeUrl(match.P)))
		...
		if ((((_v0.b && _v0.b.b) && _v0.b.b.b) && _v0.b.b.b.b) && _v0.b.b.b.b.b) {
			...
			var toMatch = function (rawUrl) {
				return _Utils_update(
					matchModel,
					{
						eo: matchModel.eo + $elm$core$String$length(regexMatch.eO),
						fX: function () {
							var _v5 = matchModel.fX;
							if (_v5.$ === 5) {
	...
	function (matchModel, model, maybeRegexMatch) {
		...
		var toMatch = function (urlTitle) {
			return _Utils_update(
				matchModel,
				{
					eo: matchModel.eo + regexMatchLength,
					fX: function () {
						var _v0 = matchModel.fX;
						if (_v0.$ === 5) {
							return $pablohirafuji$elm_markdown$Markdown$InlineParser$ImageType;
						} else {
							return $pablohirafuji$elm_markdown$Markdown$InlineParser$LinkType;
		...
		var refLabel = function (str) {
			return $elm$core$String$isEmpty(str) ? matchModel.P : str;
		}(
			A2(
				$elm$core$Maybe$withDefault,
				matchModel.P,
...
var $pablohirafuji$elm_markdown$Markdown$InlineParser$checkParsedAheadOverlapping = function (parser) {
	...
	if (!_v0.b) {
		...
		var overlappingMatches = A2(
			...
			function (_v1) {
				var testMatch = _v1;
				return (_Utils_cmp(match.eo, testMatch.fw) > 0) && (_Utils_cmp(match.eo, testMatch.eo) < 0);
			},
			remainMatches);
...
var $pablohirafuji$elm_markdown$Markdown$InlineParser$emailAutolinkTypeToMatch = function (_v0) {
	var match = _v0;
	return A2($elm$regex$Regex$contains, $pablohirafuji$elm_markdown$Markdown$InlineParser$emailRegex, match.P) ? $elm$core$Result$Ok(
		_Utils_update(
			match,
			{
				fX: $pablohirafuji$elm_markdown$Markdown$InlineParser$AutolinkType(
					_Utils_Tuple2(
						match.P,
						'mailto:' + $pablohirafuji$elm_markdown$Markdown$InlineParser$encodeUrl(match.P)))
			})) : $elm$core$Result$Err(match);
};
var $pablohirafuji$elm_markdown$Markdown$InlineParser$filterTokens = F2(
	function (filter, model) {
		return _Utils_update(
			model,
			{
				s: A2($elm$core$List$filter, filter, model.s)
			});
	});
	...
	function (model, match, regexMatch) {
		...
		if ((((_v0.b && _v0.b.b) && (!_v0.b.a.$)) && _v0.b.b.b) && _v0.b.b.b.b) {
			...
			switch (_v4.$) {
				...
				case 1:
					var allowedHtmlElements = _v4.a.cn;
					var allowedHtmlAttributes = _v4.a.cm;
	...
	function (model, _v0) {
		...
		if (_v1.$ === 2) {
			...
			return A2(
				...
				$elm$core$List$head(
					A3($elm$regex$Regex$findAtMost, 1, $pablohirafuji$elm_markdown$Markdown$InlineParser$htmlRegex, match.P)));
		}
	});
var $pablohirafuji$elm_markdown$Markdown$InlineParser$isCloseToken = F2(
	function (htmlModel, token) {
		...
		if ((_v0.$ === 5) && (!_v0.a)) {
			...
			return _Utils_eq(htmlModel.a0, htmlModel_.a0);
		} else {
			return false;
		}
	});
var $pablohirafuji$elm_markdown$Markdown$InlineParser$isCodeTokenPair = F2(
	function (closeToken, openToken) {
		...
		if (!_v0.$) {
			var isEscaped = _v0.a;
			return isEscaped ? _Utils_eq(openToken.e - 1, closeToken.e) : _Utils_eq(openToken.e, closeToken.e);
		} else {
			return false;
		}
	});
...
var $pablohirafuji$elm_markdown$Markdown$InlineParser$isOpenEmphasisToken = F2(
	function (closeToken, openToken) {
		...
		if (_v0.$ === 6) {
			...
			var openLR = _v1.a;
			var openRR = _v1.b;
			var _v2 = closeToken.j;
			if (_v2.$ === 6) {
				var closeChar = _v2.a;
				var _v3 = _v2.b;
				var closeLR = _v3.a;
				var closeRR = _v3.b;
				return _Utils_eq(openChar, closeChar) ? ((_Utils_eq(openLR, openRR) || _Utils_eq(closeLR, closeRR)) ? (!(!A2($elm$core$Basics$modBy, 3, closeToken.e + openToken.e))) : true) : false;
			} else {
				return false;
			}
		} else {
...
var $pablohirafuji$elm_markdown$Markdown$InlineParser$isVoidTag = function (htmlModel) {
	return A2($elm$core$List$member, htmlModel.a0, $pablohirafuji$elm_markdown$Markdown$InlineParser$voidHtmlTags);
};
...
var $pablohirafuji$elm_markdown$Markdown$InlineParser$reverseTokens = function (model) {
	return _Utils_update(
		model,
		{
			s: $elm$core$List$reverse(model.s)
		});
};
var $pablohirafuji$elm_markdown$Markdown$InlineParser$tokenToMatch = F2(
	function (token, type_) {
		return {eo: token.eE + token.e, d: _List_Nil, fw: token.eE, P: '', aP: 0, R: 0, fX: type_};
	});
var $pablohirafuji$elm_markdown$Markdown$InlineParser$lineBreakTTM = function (_v0) {
	...
	while (true) {
		...
		if (!tokens.b) {
			...
			if (_Utils_eq(token.j, $pablohirafuji$elm_markdown$Markdown$InlineParser$HardLineBreakToken) || (_Utils_eq(token.j, $pablohirafuji$elm_markdown$Markdown$InlineParser$SoftLineBreakToken) && model.cY.fr)) {
		...
		if (!_v0.b) {
			...
			return _Utils_Tuple2(
				A2(
					$elm$core$List$filter,
					function (token) {
						return _Utils_cmp(token.eE, match.eo) > -1;
					},
					tokensTail),
				parser);
		}
...
var $pablohirafuji$elm_markdown$Markdown$InlineParser$codeToMatch = F3(
	function (closeToken, model, _v20) {
		...
		var updtOpenToken = _Utils_eq(
			...
			openToken,
			{eE: openToken.eE + 1, e: openToken.e - 1}) : openToken;
		return _Utils_update(
			model,
			{
				d: A2(
...
var $pablohirafuji$elm_markdown$Markdown$InlineParser$emphasisToMatch = F4(
	function (closeToken, tokensTail, model, _v15) {
		...
		var remainLength = openToken.e - closeToken.e;
		var updt = (!remainLength) ? {bb: closeToken, a_: openToken, bu: remainTokens, bz: tokensTail} : ((remainLength > 0) ? {
			bb: closeToken,
			a_: _Utils_update(
				openToken,
				{eE: openToken.eE + remainLength, e: closeToken.e}),
			bu: A2(
				$elm$core$List$cons,
				_Utils_update(
					openToken,
			...
			bz: A2(
				...
				_Utils_update(
					closeToken,
					{eE: closeToken.eE + openToken.e, e: -remainLength}),
				tokensTail)
		});
		var match = A6(
			$pablohirafuji$elm_markdown$Markdown$InlineParser$tokenPairToMatch,
			...
			$pablohirafuji$elm_markdown$Markdown$InlineParser$EmphasisType(updt.a_.e),
			updt.a_,
			updt.bb,
			$elm$core$List$reverse(innerTokens));
		return _Utils_Tuple2(
				...
				return $pablohirafuji$elm_markdown$Markdown$InlineParser$linkImageTypeTTM(
					A2(
						...
						A2(
							...
							A2($pablohirafuji$elm_markdown$Markdown$InlineParser$findToken, $pablohirafuji$elm_markdown$Markdown$InlineParser$isLinkTypeOrImageOpenToken, model.s))));
			} else {
	...
	function (closeToken, tokensTail, model, _v1) {
		...
		var removeOpenToken = _Utils_Tuple2(
			...
			_Utils_update(
				model,
				{
					s: _Utils_ap(innerTokens, remainTokens)
				}));
		var remainText = A2($elm$core$String$dropLeft, closeToken.eE + 1, model.D);
		var linkOpenTokenToInactive = function (model_) {
			...
			return _Utils_update(
				model_,
				{
					s: A2($elm$core$List$map, process, model_.s)
				});
		};
...
var $pablohirafuji$elm_markdown$Markdown$InlineParser$tokenPairToMatch = F6(
	function (model, processText, type_, openToken, closeToken, innerTokens) {
		var textStart = openToken.eE + openToken.e;
		var textEnd = closeToken.eE;
		var start = openToken.eE;
		var end = closeToken.eE + closeToken.e;
		var match = {
			eo: end,
			d: _List_Nil,
			fw: start,
				...
				return A2(
					...
					function (a) {
						...
						A2(
							...
							A2($pablohirafuji$elm_markdown$Markdown$Block$parseInlines, maybeOptions, model.ac),
							function (b) {
...
var $pablohirafuji$elm_markdown$Markdown$Block$insertLinkMatch = F2(
	function (refs, linkMatch) {
		return A2($elm$core$Dict$member, linkMatch.au, refs) ? refs : A3(
			$elm$core$Dict$insert,
			linkMatch.au,
			_Utils_Tuple2(linkMatch.aA, linkMatch.bV),
			refs);
	});
var $pablohirafuji$elm_markdown$Markdown$Block$extractUrlTitleRegex = function (regexMatch) {
	...
	if ((((((_v0.b && (!_v0.a.$)) && _v0.b.b) && _v0.b.b.b) && _v0.b.b.b.b) && _v0.b.b.b.b.b) && _v0.b.b.b.b.b.b) {
		...
		var toReturn = function (rawUrl) {
			return {
				au: rawText,
				bU: $elm$core$String$length(regexMatch.eO),
...
var $pablohirafuji$elm_markdown$Markdown$Block$maybeLinkMatch = function (rawText) {
	return A2(
		$elm$core$Maybe$andThen,
		function (linkMatch) {
			return ((linkMatch.aA === '') || (linkMatch.au === '')) ? $elm$core$Maybe$Nothing : $elm$core$Maybe$Just(linkMatch);
		},
		A2(
			$elm$core$Maybe$map,
			function (linkMatch) {
				return _Utils_update(
					linkMatch,
					{
						au: $pablohirafuji$elm_markdown$Markdown$Helpers$prepareRefLabel(linkMatch.au)
					});
			},
			A2(
				$elm$core$Maybe$andThen,
...
var $author$project$Guide$Document$CustomBlock = F2(
	function (a, b) {
		return {$: 3, a: a, b: b};
	});
var $author$project$Guide$Document$ElmCodeBlock = function (a) {
	return {$: 5, a: a};
};
var $author$project$Guide$Document$Paragraph = function (a) {
	return {$: 2, a: a};
};
var $author$project$Guide$Document$PlainCodeBlock = function (a) {
	return {$: 4, a: a};
};
...
var $author$project$Guide$Syntax$addTrailingNewline = function (code) {
...
var $author$project$Guide$Syntax$removeCarriageReturns = function (code) {
	return A3($elm$core$String$replace, '\u000D', '', code);
};
var $author$project$Guide$Syntax$normalize = function (code) {
	return $author$project$Guide$Syntax$addTrailingNewline(
		$author$project$Guide$Syntax$removeCarriageReturns(code));
};
var $author$project$Guide$Syntax$Character = {$: 3};
var $author$project$Guide$Syntax$Chunk = F2(
	function (a, b) {
		return {$: 0, a: a, b: b};
	});
var $author$project$Guide$Syntax$Comment = {$: 0};
var $author$project$Guide$Syntax$Keyword = {$: 4};
var $author$project$Guide$Syntax$Number = {$: 2};
var $author$project$Guide$Syntax$String = {$: 1};
var $author$project$Guide$Syntax$Symbol = {$: 5};
var $author$project$Guide$Syntax$Whitespace = {$: 6};
...
var $elm$parser$Parser$Advanced$chompUntil = function (_v0) {
	...
	var expecting = _v0.b;
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$findSubString, str, s.c, s.fh, s.ed, s.dj);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
...
var $author$project$Guide$Syntax$between = F2(
	function (start, end) {
		return $elm$parser$Parser$getChompedString(
			A2(
				...
				A2(
					...
					$elm$parser$Parser$chompUntil(end)),
				$elm$parser$Parser$symbol(end)));
	});
var $author$project$Guide$Syntax$character = A2($author$project$Guide$Syntax$between, '\'', '\'');
var $author$project$Guide$Syntax$LocalIdentifier = {$: 7};
var $author$project$Guide$Syntax$ModuleMember = function (a) {
	return {$: 9, a: a};
};
var $author$project$Guide$Syntax$TypeOrModule = {$: 8};
var $author$project$Guide$Syntax$isNotCapitalized = function (str) {
	var firstCharacter = A2($elm$core$String$left, 1, str);
	return _Utils_eq(
		$elm$core$String$toLower(firstCharacter),
		firstCharacter);
};
...
var $author$project$Guide$Syntax$identifierType = function (fullString) {
	var parts = A2(
		$elm$core$List$filter,
		A2($elm$core$Basics$composeL, $elm$core$Basics$not, $elm$core$String$isEmpty),
		A2($elm$core$String$split, '.', fullString));
	var _v0 = A2($elm_community$list_extra$List$Extra$splitWhen, $author$project$Guide$Syntax$isNotCapitalized, parts);
	_v0$1:
	while (true) {
		if (_v0.$ === 1) {
			return $author$project$Guide$Syntax$TypeOrModule;
		} else {
			if (!_v0.a.b.b) {
				if (!_v0.a.a.b) {
					break _v0$1;
				...
				if (!_v0.a.a.b) {
					...
					var _v3 = _v0.a;
					var moduleParts = _v3.a;
					var _v4 = _v3.b;
					var memberName = _v4.a;
					return $author$project$Guide$Syntax$ModuleMember(
						{
							eR: memberName,
							eU: A2($elm$core$String$join, '.', moduleParts)
						});
				}
			}
		}
	...
	var _v1 = _v0.a;
	return $author$project$Guide$Syntax$LocalIdentifier;
};
var $author$project$Guide$Syntax$classifyIdentifier = function (fullString) {
	return A2(
		$author$project$Guide$Syntax$Chunk,
		$author$project$Guide$Syntax$identifierType(fullString),
		fullString);
};
var $author$project$Guide$Syntax$comment = $elm$parser$Parser$oneOf(
	_List_fromArray(
		[
			A2($author$project$Guide$Syntax$between, '{-', '-}'),
			A2($author$project$Guide$Syntax$between, '--', '\n')
		]));
var $author$project$Guide$Syntax$identifier = $elm$parser$Parser$getChompedString(
	$elm$parser$Parser$variable(
		{
			eG: function (_char) {
				return $elm$core$Char$isAlphaNum(_char) || (_char === '.');
			},
			fd: $elm$core$Set$empty,
			fw: function (_char) {
				return $elm$core$Char$isAlpha(_char) || (_char === '_');
			}
		}));
...
var $elm$parser$Parser$Advanced$keyword = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, kwd, s.c, s.fh, s.ed, s.dj);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
...
var $author$project$Guide$Syntax$keyword = $elm$parser$Parser$getChompedString(
...
var $elm$parser$Parser$Advanced$bumpOffset = F2(
	function (newOffset, s) {
		return {ed: s.ed + (newOffset - s.c), i: s.i, r: s.r, c: newOffset, fh: s.fh, dj: s.dj};
	});
...
var $elm$parser$Parser$Advanced$finalizeFloat = F6(
	function (invalid, expecting, intSettings, floatSettings, intPair, s) {
		...
		var floatOffset = A2($elm$parser$Parser$Advanced$consumeDotAndExp, intOffset, s.dj);
		if (floatOffset < 0) {
			return A2(
				$elm$parser$Parser$Advanced$Bad,
				true,
				A4($elm$parser$Parser$Advanced$fromInfo, s.fh, s.ed - (floatOffset + s.c), invalid, s.i));
		} else {
				...
				if (_Utils_eq(intOffset, floatOffset)) {
					...
					if (floatSettings.$ === 1) {
						...
						var _v1 = $elm$core$String$toFloat(
							A3($elm$core$String$slice, s.c, floatOffset, s.dj));
						if (_v1.$ === 1) {
							return A2(
								$elm$parser$Parser$Advanced$Bad,
								true,
...
var $elm$parser$Parser$Advanced$number = function (c) {
	return function (s) {
		if (A3($elm$parser$Parser$Advanced$isAsciiCode, 48, s.c, s.dj)) {
			var zeroOffset = s.c + 1;
			var baseOffset = zeroOffset + 1;
			return A3($elm$parser$Parser$Advanced$isAsciiCode, 120, zeroOffset, s.dj) ? A5(
				$elm$parser$Parser$Advanced$finalizeInt,
				c.eK,
				c.ex,
				baseOffset,
				A2($elm$parser$Parser$Advanced$consumeBase16, baseOffset, s.dj),
				s) : (A3($elm$parser$Parser$Advanced$isAsciiCode, 111, zeroOffset, s.dj) ? A5(
				$elm$parser$Parser$Advanced$finalizeInt,
				c.eK,
				c.eY,
				baseOffset,
				A3($elm$parser$Parser$Advanced$consumeBase, 8, baseOffset, s.dj),
				s) : (A3($elm$parser$Parser$Advanced$isAsciiCode, 98, zeroOffset, s.dj) ? A5(
				$elm$parser$Parser$Advanced$finalizeInt,
				c.eK,
				c.dZ,
				baseOffset,
				A3($elm$parser$Parser$Advanced$consumeBase, 2, baseOffset, s.dj),
				s) : A6(
			...
			return A6(
				...
				c.eJ,
				c.er,
				A3($elm$parser$Parser$Advanced$consumeBase, 10, s.c, s.dj),
				s);
		}
	};
};
var $elm$parser$Parser$number = function (i) {
	return $elm$parser$Parser$Advanced$number(
		{
			dZ: A2($elm$core$Result$fromMaybe, $elm$parser$Parser$ExpectingBinary, i.dZ),
			cE: $elm$parser$Parser$ExpectingNumber,
			er: A2($elm$core$Result$fromMaybe, $elm$parser$Parser$ExpectingFloat, i.er),
			ex: A2($elm$core$Result$fromMaybe, $elm$parser$Parser$ExpectingHex, i.ex),
...
var $author$project$Guide$Syntax$number = function () {
	var bareNumber = $elm$parser$Parser$number(
		{
...
var $author$project$Guide$Syntax$string = A2($author$project$Guide$Syntax$between, '\"', '\"');
var $author$project$Guide$Syntax$symbol = $elm$parser$Parser$getChompedString(
	$elm$parser$Parser$oneOf(
		A2(
			$elm$core$List$map,
			$elm$parser$Parser$token,
...
var $elm$parser$Parser$Advanced$chompIf = F2(
	function (isGood, expecting) {
		return function (s) {
			var newOffset = A3($elm$parser$Parser$Advanced$isSubChar, isGood, s.c, s.dj);
			return _Utils_eq(newOffset, -1) ? A2(
				$elm$parser$Parser$Advanced$Bad,
				false,
				...
				true,
				0,
				{ed: 1, i: s.i, r: s.r, c: s.c + 1, fh: s.fh + 1, dj: s.dj}) : A3(
				$elm$parser$Parser$Advanced$Good,
				true,
				0,
				{ed: s.ed + 1, i: s.i, r: s.r, c: newOffset, fh: s.fh, dj: s.dj}));
		};
	});
var $elm$parser$Parser$chompIf = function (isGood) {
	return A2($elm$parser$Parser$Advanced$chompIf, isGood, $elm$parser$Parser$UnexpectedChar);
};
var $author$project$Guide$Syntax$isWhitespace = function (_char) {
	return (_char === ' ') || (_char === '\n');
};
var $author$project$Guide$Syntax$whitespace = $elm$parser$Parser$getChompedString(
	A2(
		$elm$parser$Parser$ignorer,
		$elm$parser$Parser$chompIf($author$project$Guide$Syntax$isWhitespace),
		$elm$parser$Parser$chompWhile($author$project$Guide$Syntax$isWhitespace)));
var $author$project$Guide$Syntax$chunk = $elm$parser$Parser$oneOf(
	_List_fromArray(
		[
			A2(
			$elm$parser$Parser$map,
			$author$project$Guide$Syntax$Chunk($author$project$Guide$Syntax$Whitespace),
			$author$project$Guide$Syntax$whitespace),
			A2(
			$elm$parser$Parser$map,
			$author$project$Guide$Syntax$Chunk($author$project$Guide$Syntax$Comment),
			$author$project$Guide$Syntax$comment),
			A2(
			$elm$parser$Parser$map,
			$author$project$Guide$Syntax$Chunk($author$project$Guide$Syntax$String),
			$author$project$Guide$Syntax$string),
			A2(
			$elm$parser$Parser$map,
			$author$project$Guide$Syntax$Chunk($author$project$Guide$Syntax$Character),
			$author$project$Guide$Syntax$character),
			A2(
			$elm$parser$Parser$map,
			$author$project$Guide$Syntax$Chunk($author$project$Guide$Syntax$Keyword),
			$author$project$Guide$Syntax$keyword),
			A2(
			$elm$parser$Parser$map,
			$author$project$Guide$Syntax$Chunk($author$project$Guide$Syntax$Symbol),
			$author$project$Guide$Syntax$symbol),
			A2($elm$parser$Parser$map, $author$project$Guide$Syntax$classifyIdentifier, $author$project$Guide$Syntax$identifier),
			A2(
			$elm$parser$Parser$map,
			$author$project$Guide$Syntax$Chunk($author$project$Guide$Syntax$Number),
			$author$project$Guide$Syntax$number)
		]));
var $elm$parser$Parser$ExpectingEnd = {$: 10};
var $elm$parser$Parser$Advanced$end = function (x) {
	return function (s) {
		return _Utils_eq(
			$elm$core$String$length(s.dj),
...
var $author$project$Guide$Syntax$parseHelp = function (accumulated) {
	return $elm$parser$Parser$oneOf(
		_List_fromArray(
			[
				A2(
				...
				$elm$parser$Parser$succeed(
					function (parsedChunk) {
						return $elm$parser$Parser$Loop(
							A2($elm$core$List$cons, parsedChunk, accumulated));
					}),
				$author$project$Guide$Syntax$chunk),
				A2(
				$elm$parser$Parser$keeper,
...
var $author$project$Guide$Syntax$parser = A2($elm$parser$Parser$loop, _List_Nil, $author$project$Guide$Syntax$parseHelp);
var $author$project$Guide$Syntax$splitLinesHelp = F3(
	function (accumulatedLines, accumulatedChunks, chunks) {
		splitLinesHelp:
		while (true) {
			if (chunks.b) {
				var firstChunk = chunks.a;
				var remainingChunks = chunks.b;
				var _v1 = firstChunk;
				var chunkType = _v1.a;
				var chunkText = _v1.b;
				var _v2 = $elm$core$String$lines(chunkText);
				if (!_v2.b) {
					var $temp$accumulatedLines = accumulatedLines,
						$temp$accumulatedChunks = accumulatedChunks,
						$temp$chunks = remainingChunks;
					accumulatedLines = $temp$accumulatedLines;
					accumulatedChunks = $temp$accumulatedChunks;
					chunks = $temp$chunks;
					continue splitLinesHelp;
				} else {
					if (!_v2.b.b) {
						var fragmentNotAtEndOfLine = _v2.a;
						if ($elm$core$String$isEmpty(fragmentNotAtEndOfLine)) {
							var $temp$accumulatedLines = accumulatedLines,
								$temp$accumulatedChunks = accumulatedChunks,
								$temp$chunks = remainingChunks;
							accumulatedLines = $temp$accumulatedLines;
							...
							var $temp$accumulatedLines = accumulatedLines,
								$temp$accumulatedChunks = A2(
								$elm$core$List$cons,
								A2($author$project$Guide$Syntax$Chunk, chunkType, fragmentNotAtEndOfLine),
								accumulatedChunks),
								$temp$chunks = remainingChunks;
							accumulatedLines = $temp$accumulatedLines;
							accumulatedChunks = $temp$accumulatedChunks;
						...
						var fragmentAtEndOfLine = _v2.a;
						var followingFragments = _v2.b;
						var newLine = $elm$core$List$reverse(
							A2(
								$elm$core$List$cons,
								A2($author$project$Guide$Syntax$Chunk, chunkType, fragmentAtEndOfLine),
								accumulatedChunks));
						var $temp$accumulatedLines = A2($elm$core$List$cons, newLine, accumulatedLines),
							$temp$accumulatedChunks = _List_Nil,
							$temp$chunks = A2(
							$elm$core$List$cons,
							A2(
								$author$project$Guide$Syntax$Chunk,
				...
				return $elm$core$List$isEmpty(accumulatedChunks) ? $elm$core$List$reverse(accumulatedLines) : $elm$core$List$reverse(
					A2(
						$elm$core$List$cons,
						$elm$core$List$reverse(accumulatedChunks),
						accumulatedLines));
			}
		}
	});
var $author$project$Guide$Syntax$splitLines = function (chunks) {
	return A3($author$project$Guide$Syntax$splitLinesHelp, _List_Nil, _List_Nil, chunks);
};
var $author$project$Guide$Syntax$toMessage = function (deadEnds) {
	if (deadEnds.b) {
		var first = deadEnds.a;
		return $elm$core$String$concat(
			_List_fromArray(
				[
					'Syntax parsing error at row ',
					$elm$core$String$fromInt(first.fh),
					', column ',
					$elm$core$String$fromInt(first.ed)
				]));
	} else {
		return 'Syntax parsing error';
	}
};
var $author$project$Guide$Syntax$parse = function (code) {
	return A2(
		$elm$core$Result$mapError,
		$author$project$Guide$Syntax$toMessage,
		A2(
			$elm$core$Result$map,
			$author$project$Guide$Syntax$splitLines,
			A2(
				$elm$parser$Parser$run,
				$author$project$Guide$Syntax$parser,
				$author$project$Guide$Syntax$normalize(code))));
};
...
var $author$project$Guide$Document$toInlineCodeChunk = function (match) {
	...
	while (true) {
		if (_v0.b) {
			if (!_v0.a.$) {
				if ((_v0.b.b && (_v0.b.a.$ === 1)) && (!_v0.b.b.b)) {
					var spaces = _v0.a.a;
					var _v1 = _v0.b;
					var _v2 = _v1.a;
						...
						while (true) {
							if (urlInlines.b && (!urlInlines.b.b)) {
								switch (urlInlines.a.$) {
									...
									case 4:
										var _v7 = urlInlines.a;
										var imageUrl = _v7.a;
										var imageInlines = _v7.c;
										return prependLink(
											$author$project$Guide$Document$Image(
												{
													cz: $pablohirafuji$elm_markdown$Markdown$Inline$extractText(imageInlines),
													aA: imageUrl
												}));
									default:
										break _v2$5;
		...
		while (true) {
			if (blocks.b) {
				...
				var parseCode = function (code) {
					var _v11 = $author$project$Guide$Syntax$parse(code);
					if (!_v11.$) {
						var lines = _v11.a;
						return prepend(
							$author$project$Guide$Document$ElmCodeBlock(lines));
					} else {
						var message = _v11.a;
						...
						if (!first.a.$) {
							...
							if (!_v5.$) {
								switch (_v5.a) {
									...
									case 'text':
										return prepend(
											$author$project$Guide$Document$PlainCodeBlock(code));
									default:
										var language = _v5.a;
										return $elm$core$Result$Err('Language ' + (language + ' not recognized'));
								}
							} else {
								return prepend(
									$author$project$Guide$Document$PlainCodeBlock(code));
					...
					case 7:
						...
						if ((inlines.b && (inlines.a.$ === 5)) && (!inlines.b.b)) {
							if ((!inlines.a.b.b) && (!inlines.a.c.b)) {
								var _v8 = inlines.a;
								var tag = _v8.a;
								var _v9 = A2($elm$core$Dict$get, tag, widgets);
								if (!_v9.$) {
									var registeredWidget = _v9.a;
									return prepend(
										A2($author$project$Guide$Document$CustomBlock, 0, registeredWidget));
								} else {
...
var $author$project$Guide$Document$tagBullets = F2(
	function (bullets, nextId) {
		if (bullets.b) {
			var first = bullets.a;
			var rest = bullets.b;
			var _v6 = A2($author$project$Guide$Document$tagBullets, rest, nextId);
			var taggedRest = _v6.a;
			var updatedId = _v6.b;
			var _v7 = A2($author$project$Guide$Document$tagChunks, first, updatedId);
			var taggedFirst = _v7.a;
			var finalId = _v7.b;
			return _Utils_Tuple2(
				A2($elm$core$List$cons, taggedFirst, taggedRest),
				finalId);
		} else {
			return _Utils_Tuple2(_List_Nil, nextId);
		}
	});
var $author$project$Guide$Document$tagChunk = F2(
	function (chunk, nextId) {
		switch (chunk.$) {
			case 0:
				var textFragments = chunk.a;
				return _Utils_Tuple2(
					$author$project$Guide$Document$Section(textFragments),
					nextId);
			case 1:
				var textFragments = chunk.a;
				return _Utils_Tuple2(
					$author$project$Guide$Document$Subsection(textFragments),
					nextId);
			case 2:
				var textFragments = chunk.a;
				return _Utils_Tuple2(
					$author$project$Guide$Document$Paragraph(textFragments),
					nextId);
			case 3:
				var widget = chunk.b;
				return _Utils_Tuple2(
					A2($author$project$Guide$Document$CustomBlock, nextId, widget),
					nextId + 1);
			case 4:
				var code = chunk.a;
				return _Utils_Tuple2(
					...
					nextId);
			case 5:
				var syntaxChunks = chunk.a;
				return _Utils_Tuple2(
					$author$project$Guide$Document$ElmCodeBlock(syntaxChunks),
					nextId);
			default:
				var bullets = chunk.a;
				var _v4 = A2($author$project$Guide$Document$tagBullets, bullets, nextId);
				var taggedBullets = _v4.a;
				var updatedId = _v4.b;
				return _Utils_Tuple2(
					$author$project$Guide$Document$Bullets(taggedBullets),
					updatedId);
		}
	});
var $author$project$Guide$Document$tagChunks = F2(
	function (chunks, nextId) {
		if (chunks.b) {
			var first = chunks.a;
			var rest = chunks.b;
			var _v1 = A2($author$project$Guide$Document$tagChunks, rest, nextId);
			var taggedRest = _v1.a;
			var updatedId = _v1.b;
			var _v2 = A2($author$project$Guide$Document$tagChunk, first, updatedId);
			var taggedFirst = _v2.a;
			var finalId = _v2.b;
			return _Utils_Tuple2(
				A2($elm$core$List$cons, taggedFirst, taggedRest),
				finalId);
...
var $author$project$Guide$Document$parse = F2(
	function (widgets, markdown) {
		var options = {fa: $pablohirafuji$elm_markdown$Markdown$Config$ParseUnsafe, fr: false};
		var blocks = A2(
			...
			return A3(
				...
				F2(
					function (titleText, bodyChunks) {
						return _Utils_Tuple2(
							{
								ba: A2($author$project$Guide$Document$tagChunks, bodyChunks, 1).a,
								dr: titleText
							},
							$author$project$Guide$Document$collectImageUrls(blocks));
					}),
				A2($author$project$Guide$Document$parseText, inlines, _List_Nil),
				A3($author$project$Guide$Document$parseChunks, widgets, rest, _List_Nil));
		} else {
			return $elm$core$Result$Err('Markdown document must start with a level 1 header');
		}
	});
var $author$project$Guide$handleMarkdown = F4(
	function (page, fragment, widgets, result) {
		if (!result.$) {
			var markdown = result.a.cS;
			var lastModified = result.a.aH;
			var _v1 = A2($author$project$Guide$Document$parse, widgets, markdown);
			if (!_v1.$) {
				var _v2 = _v1.a;
				var document = _v2.a;
				var imagesToLoad = _v2.b;
				return $author$project$Guide$DocumentLoaded(
					{bh: document, as: fragment, bk: imagesToLoad, aH: lastModified, br: page});
			} else {
				var message = _v1.a;
...
var $author$project$Guide$toDateString = F6(
	function (day, month, year, _v0, _v1, _v2) {
...
var $author$project$Guide$handleResponse = function (response) {
	switch (response.$) {
		...
		case 3:
			var metadata = response.a;
			return $elm$core$Result$Err(
				'Got an HTTP ' + ($elm$core$String$fromInt(metadata.fy) + ' error code when loading page'));
		default:
			var metadata = response.a;
			...
			var parsedDate = A2(
				...
				function (lastModified) {
					var _v1 = A2($elm$parser$Parser$run, $author$project$Guide$dateParser, lastModified);
					if (!_v1.$) {
						var parsed = _v1.a;
						return parsed;
					} else {
				...
				A2($elm$core$Dict$get, 'last-modified', metadata.ev));
			return $elm$core$Result$Ok(
				{aH: parsedDate, cS: content});
	}
};
...
var $author$project$Guide$Page$sourceUrl = F2(
		...
		if (!page.$) {
			...
			return A2(
				...
				_Utils_ap(
					rootPath,
					_List_fromArray(
						['pages', properties.dq + '.md'])),
				_List_Nil);
		}
	});
var $author$project$Guide$loadPage = F4(
	function (rootPath, page, fragment, widgets) {
		return $elm$http$Http$get(
			{
				cD: A2(
					$elm$http$Http$expectStringResponse,
					A3($author$project$Guide$handleMarkdown, page, fragment, widgets),
					$author$project$Guide$handleResponse),
				aA: A2($author$project$Guide$Page$sourceUrl, rootPath, page)
			});
	});
var $author$project$Guide$Page$BadUrl = {$: 1};
var $author$project$Guide$Page$Match = function (a) {
	return {$: 0, a: a};
};
var $author$project$Guide$Page$NotFound = function (a) {
	return {$: 0, a: a};
};
var $author$project$Guide$Page$Unspecified = {$: 1};
...
var $elm$url$Url$Parser$State = F5(
	function (visited, unvisited, params, frag, value) {
		return {ar: frag, ay: params, aj: unvisited, Y: value, aB: visited};
	});
		...
		return $elm$url$Url$Parser$getFirstMatch(
			parser(
				A5(
					...
					_List_Nil,
					$elm$url$Url$Parser$preparePath(url.e6),
...
var $author$project$Guide$Page$urlParser = function (rootPath) {
	var rootParser = A3(
		$elm$core$List$foldl,
		F2(
			function (segment, current) {
				return A2($elm$url$Url$Parser$slash, current, segment);
			}),
		$elm$url$Url$Parser$top,
		A2($elm$core$List$map, $elm$url$Url$Parser$s, rootPath));
	return A2(
...
var $author$project$Guide$Page$matching = F2(
	function (_v0, pages) {
		...
		var _v1 = A2(
			...
			$author$project$Guide$Page$urlParser(rootPath),
			url);
		if (!_v1.$) {
			var query = _v1.a.c6;
			if (!query.$) {
				var pageTitle = query.a;
				var _v3 = A2(
					$elm$core$List$filter,
					$author$project$Guide$Page$matchesQuery(pageTitle),
					pages);
				if (_v3.b && (!_v3.b.b)) {
					var page = _v3.a;
					return $elm$core$Result$Ok(
						$author$project$Guide$Page$Match(page));
				} else {
					return $elm$core$Result$Err(
						$author$project$Guide$Page$NotFound(pageTitle));
				}
			} else {
				return $elm$core$Result$Ok($author$project$Guide$Page$Unspecified);
			}
		} else {
...
var $author$project$Guide$NoOp = {$: 6};
...
var $author$project$Guide$scrollTo = function (fragment) {
	if (!fragment.$) {
		var id = fragment.a;
		return A2(
			...
			A2(
				...
				function (_v1) {
					var element = _v1.em;
					return A2($elm$browser$Browser$Dom$setViewport, 0, element.b);
				},
...
var $author$project$Guide$handleNewUrl = F7(
	function (currentState, rootPath, readmePage, allPages, screenClass, url, widgets) {
		var _v0 = A2(
		...
		if (!_v0.$) {
			if (!_v0.a.$) {
				var page = _v0.a.a;
				var loadNewPage = A4($author$project$Guide$loadPage, rootPath, page, url.as, widgets);
				var command = function () {
					if (currentState.$ === 3) {
						var current = currentState.a;
						return _Utils_eq(page, current.br) ? $author$project$Guide$scrollTo(url.as) : loadNewPage;
					} else {
						return loadNewPage;
					}
				}();
				...
				var _v2 = _v0.a;
				if (screenClass === 1) {
					var loadReadme = A4($author$project$Guide$loadPage, rootPath, readmePage, url.as, widgets);
					return _Utils_Tuple2(
						currentState,
						function () {
							if (currentState.$ === 3) {
								var current = currentState.a;
								return $author$project$Guide$Page$isReadme(current.br) ? $author$project$Guide$scrollTo(url.as) : loadReadme;
							} else {
								return loadReadme;
							}
						}());
			...
			if (!_v0.a.$) {
				var title = _v0.a.a;
				var errorMessage = 'Page \"' + (title + '\" not found');
				return _Utils_Tuple2(
...
var $author$project$Guide$init = F8(
	function (author, packageName, givenWidgets, readmePage, allPages, flags, url, navigationKey) {
		var widgets = $elm$core$Dict$fromList(givenWidgets);
		var screenClass = $author$project$Guide$Screen$classify(flags.dB);
		var rootPath = A2(
			$elm$core$List$filter,
			A2($elm$core$Basics$composeL, $elm$core$Basics$not, $elm$core$String$isEmpty),
			A2($elm$core$String$split, '/', url.e6));
		var moduleNamesDecoder = $elm$json$Json$Decode$list(
			A2(
				$elm$json$Json$Decode$map,
				function ($) {
					return $.eW;
				},
				$elm$project_metadata_utils$Elm$Docs$decoder));
		var loadDocs = $elm$http$Http$get(
			{
				cD: A2($elm$http$Http$expectJson, $author$project$Guide$DocsJsonResponse, moduleNamesDecoder),
				aA: 'docs.json'
			});
		var _v0 = A7($author$project$Guide$handleNewUrl, $author$project$Guide$Loading, rootPath, readmePage, allPages, screenClass, url, widgets);
		var state = _v0.a;
		var pageCommand = _v0.b;
		return _Utils_Tuple2(
			{a7: allPages, an: author, aZ: $elm$core$Set$empty, cW: navigationKey, V: packageName, bt: readmePage, aN: rootPath, N: screenClass, E: state, a6: widgets},
			$elm$core$Platform$Cmd$batch(
				_List_fromArray(
					[pageCommand, loadDocs])));
	});
...
var $author$project$Guide$Loaded = function (a) {
	return {$: 3, a: a};
};
...
var $author$project$Guide$update = F2(
	function (message, model) {
		switch (message.$) {
			...
			case 1:
				var url = message.a;
				var _v2 = A7($author$project$Guide$handleNewUrl, model.E, model.aN, model.bt, model.a7, model.N, url, model.a6);
				var newState = _v2.a;
				var command = _v2.b;
				return _Utils_Tuple2(
					_Utils_update(
			...
			case 2:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							E: $author$project$Guide$Error(string)
						}),
					$elm$core$Platform$Cmd$none);
			case 3:
				var loaded = message.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							E: $author$project$Guide$Loaded(loaded)
						}),
					$elm$core$Set$isEmpty(loaded.bk) ? $author$project$Guide$scrollTo(loaded.as) : $elm$core$Platform$Cmd$none);
			case 4:
				if (!message.a.$) {
					var newDocument = message.a.a;
					var _v3 = model.E;
					if (_v3.$ === 3) {
						var current = _v3.a;
						return _Utils_Tuple2(
					...
					if (_v4.$ === 3) {
						var current = _v4.a;
						var updatedImagesToLoad = A2($elm$core$Set$remove, url, current.bk);
						return _Utils_Tuple2(
							_Utils_update(
								model,
								{
									E: $author$project$Guide$Loaded(
										_Utils_update(
											current,
											{bk: updatedImagesToLoad}))
								}),
							$elm$core$Set$isEmpty(updatedImagesToLoad) ? $author$project$Guide$scrollTo(current.as) : $elm$core$Platform$Cmd$none);
					} else {
						return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
					}
				}
			case 5:
				if (!message.a.$) {
					var moduleNames = message.a.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								aZ: $elm$core$Set$fromList(moduleNames)
							}),
						$elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
...
var $mdgriffith$elm_ui$Internal$Style$classes = {dG: 'a', bA: 'atv', dI: 'ab', dJ: 'cx', dK: 'cy', dL: 'acb', dM: 'accx', dN: 'accy', dO: 'acr', ck: 'al', cl: 'ar', dP: 'at', bB: 'ah', bC: 'av', dS: 's', dX: 'bh', dY: 'b', d$: 'w7', d1: 'bd', d2: 'bdt', a8: 'bn', d3: 'bs', a9: 'cpe', ea: 'cp', eb: 'cpx', ec: 'cpy', ef: 'c', bd: 'ctr', be: 'cb', bf: 'ccx', aa: 'ccy', aS: 'cl', bg: 'cr', eg: 'ct', ei: 'cptr', ej: 'ctxt', es: 'fcs', et: 'fs', eu: 'g', bJ: 'hbh', bj: 'hc', bK: 'hf', cI: 'hfp', ez: 'hv', eB: 'ic', eD: 'fr', eH: 'iml', eI: 'it', eL: 'i', aI: 'nb', cX: 'notxt', eZ: 'ol', e$: 'or', ax: 'oq', e3: 'oh', br: 'pg', c_: 'p', e5: 'ppe', ff: 'ui', fh: 'r', fj: 'sb', fk: 'sbx', fl: 'sby', fm: 'sbt', fp: 'e', fq: 'cap', fs: 'sev', fC: 'sk', P: 't', fG: 'tc', fH: 'w8', fI: 'w2', fJ: 'w9', fK: 'tj', bx: 'tja', fL: 'tl', fM: 'w3', fN: 'w5', fO: 'w4', fP: 'tr', fQ: 'w6', fR: 'w1', fS: 'tun', dv: 'ts', az: 'clr', fY: 'u', cg: 'wc', dC: 'we', ch: 'wf', dD: 'wfp', ci: 'wrp'};
var $mdgriffith$elm_ui$Internal$Model$columnClass = $mdgriffith$elm_ui$Internal$Style$classes.dS + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.ef);
var $mdgriffith$elm_ui$Internal$Model$gridClass = $mdgriffith$elm_ui$Internal$Style$classes.dS + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.eu);
var $mdgriffith$elm_ui$Internal$Model$pageClass = $mdgriffith$elm_ui$Internal$Style$classes.dS + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.br);
var $mdgriffith$elm_ui$Internal$Model$paragraphClass = $mdgriffith$elm_ui$Internal$Style$classes.dS + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.c_);
var $mdgriffith$elm_ui$Internal$Model$rowClass = $mdgriffith$elm_ui$Internal$Style$classes.dS + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.fh);
var $mdgriffith$elm_ui$Internal$Model$singleClass = $mdgriffith$elm_ui$Internal$Style$classes.dS + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.fp);
	...
	switch (style.$) {
		...
		case 8:
			...
			return 'grid-rows-' + (A2(
				...
				$elm$core$String$join,
				'-',
				A2($elm$core$List$map, $mdgriffith$elm_ui$Internal$Model$lengthClassName, template.S)) + ('-space-x-' + ($mdgriffith$elm_ui$Internal$Model$lengthClassName(template.ft.a) + ('-space-y-' + $mdgriffith$elm_ui$Internal$Model$lengthClassName(template.ft.b)))))));
		case 9:
			var pos = style.a;
			return 'gp grid-pos-' + ($elm$core$String$fromInt(pos.fh) + ('-' + ($elm$core$String$fromInt(pos.ed) + ('-' + ($elm$core$String$fromInt(pos.dB) + ('-' + $elm$core$String$fromInt(pos.ew)))))));
		case 11:
		...
		A2(
			...
			_List_fromArray(
				[
					...
					$elm$core$Maybe$Just(
					$mdgriffith$elm_ui$Internal$Model$formatColor(shadow.ee))
				])));
};
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.ez, $mdgriffith$elm_ui$Internal$Style$classes.az)) + ':hover',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.ez, $mdgriffith$elm_ui$Internal$Style$classes.ax)) + ':hover',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.es, $mdgriffith$elm_ui$Internal$Style$classes.az)) + ':focus',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.es, $mdgriffith$elm_ui$Internal$Style$classes.ax)) + ':focus',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.bA, $mdgriffith$elm_ui$Internal$Style$classes.az)) + ':active',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '0')
					])),
				...
				$mdgriffith$elm_ui$Internal$Style$Descriptor,
				$mdgriffith$elm_ui$Internal$Style$dot(
					_Utils_ap($mdgriffith$elm_ui$Internal$Style$classes.bA, $mdgriffith$elm_ui$Internal$Style$classes.ax)) + ':active',
				_List_fromArray(
					[
						A2($mdgriffith$elm_ui$Internal$Style$Prop, 'opacity', '1')
					])),
...
var $mdgriffith$elm_ui$Internal$Style$overrides = '@media screen and (-ms-high-contrast: active), (-ms-high-contrast: none) {' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.dS) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.fh) + (' > ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.dS) + (' { flex-basis: auto !important; } ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.dS) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.fh) + (' > ' + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.dS) + ($mdgriffith$elm_ui$Internal$Style$dot($mdgriffith$elm_ui$Internal$Style$classes.bd) + (' { flex-basis: auto !important; }}' + ($mdgriffith$elm_ui$Internal$Style$sliderOverrides + $mdgriffith$elm_ui$Internal$Style$explainer))))))))))));
var $mdgriffith$elm_ui$Internal$Style$Intermediate = $elm$core$Basics$identity;
var $mdgriffith$elm_ui$Internal$Style$emptyIntermediate = F2(
	function (selector, closing) {
		return {bc: closing, B: _List_Nil, ai: _List_Nil, W: selector};
	});
					...
					case 2:
						...
						return _Utils_update(
							rendered,
							{
								B: A2(
									$elm$core$List$cons,
									{bc: '\n}', B: _List_Nil, ai: props, W: '@supports (' + (prop + (':' + (value + (') {' + parent.W))))},
									rendered.B)
							});
					case 4:
						var selector = rule.a;
...
var $mdgriffith$elm_ui$Internal$Style$renderCompact = function (styleClasses) {
	...
	var renderClass = function (rule) {
		...
		if (!_v2.b) {
			...
			return rule.W + ('{' + (renderValues(rule.ai) + (rule.bc + '}')));
		}
	};
...
var $mdgriffith$elm_ui$Internal$Model$hasSmallCaps = function (typeface) {
	if (typeface.$ === 5) {
		var font = typeface.a;
		return A2($elm$core$List$any, $mdgriffith$elm_ui$Internal$Model$isSmallCaps, font.dx);
	} else {
		return false;
	}
};
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					A2(
					$mdgriffith$elm_ui$Internal$Model$bracket,
					'.' + (name + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.fq + ('> .' + ($mdgriffith$elm_ui$Internal$Style$classes.P + (', .' + (name + (' .' + ($mdgriffith$elm_ui$Internal$Style$classes.fq + (' > .' + $mdgriffith$elm_ui$Internal$Style$classes.P)))))))))),
					_List_fromArray(
						[
...
var $mdgriffith$elm_ui$Internal$Model$adjust = F3(
	function (size, height, vertical) {
		return {ew: height / size, dh: size, dz: vertical};
	});
...
var $mdgriffith$elm_ui$Internal$Model$convertAdjustment = function (adjustment) {
	var lines = _List_fromArray(
		[adjustment.d7, adjustment.dW, adjustment.el, adjustment.eN]);
	var lineHeight = 1.5;
	...
	if (typeface.$ === 5) {
		...
		return $elm$core$Maybe$Just(
			A2(
				$elm$core$String$join,
				', ',
				A2($elm$core$List$map, $mdgriffith$elm_ui$Internal$Model$renderVariant, font.dx)));
	} else {
		return $elm$core$Maybe$Nothing;
	}
};
			...
			function (rule, maybePseudo) {
				switch (rule.$) {
					...
					case 5:
						...
						var single = '.' + $mdgriffith$elm_ui$Internal$Style$classes.fp;
						...
						var column = '.' + $mdgriffith$elm_ui$Internal$Style$classes.ef;
						var _class = '.' + cls;
					...
					case 9:
						...
						var modernPosition = A2(
							...
							_List_fromArray(
								[
									'grid-row: ' + ($elm$core$String$fromInt(position.fh) + (' / ' + ($elm$core$String$fromInt(position.fh + position.ew) + ';'))),
									'grid-column: ' + ($elm$core$String$fromInt(position.ed) + (' / ' + ($elm$core$String$fromInt(position.ed + position.dB) + ';')))
								]));
						var _class = '.grid-pos-' + ($elm$core$String$fromInt(position.fh) + ('-' + ($elm$core$String$fromInt(position.ed) + ('-' + ($elm$core$String$fromInt(position.dB) + ('-' + $elm$core$String$fromInt(position.ew)))))));
					...
					return A3(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$Attributes$class($mdgriffith$elm_ui$Internal$Style$classes.dS + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.fp))
									]))
							]));
			}
		}();
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.dS, $mdgriffith$elm_ui$Internal$Style$classes.fp, $mdgriffith$elm_ui$Internal$Style$classes.bd, $mdgriffith$elm_ui$Internal$Style$classes.aa, $mdgriffith$elm_ui$Internal$Style$classes.dO])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.dS, $mdgriffith$elm_ui$Internal$Style$classes.fp, $mdgriffith$elm_ui$Internal$Style$classes.bd, $mdgriffith$elm_ui$Internal$Style$classes.aa, $mdgriffith$elm_ui$Internal$Style$classes.dM])))
						]),
					_List_fromArray(
						[html])) : html));
			case 1:
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.dS, $mdgriffith$elm_ui$Internal$Style$classes.fp, $mdgriffith$elm_ui$Internal$Style$classes.bd, $mdgriffith$elm_ui$Internal$Style$classes.dN])))
						]),
					_List_fromArray(
					...
					_List_fromArray(
						[
							...
							A2(
								...
								' ',
								_List_fromArray(
									[$mdgriffith$elm_ui$Internal$Style$classes.dS, $mdgriffith$elm_ui$Internal$Style$classes.fp, $mdgriffith$elm_ui$Internal$Style$classes.bd, $mdgriffith$elm_ui$Internal$Style$classes.dL])))
						]),
					_List_fromArray(
						[html])) : html));
			default:
		...
		_List_fromArray(
			[
				...
				A2(
					...
					' ',
					_List_fromArray(
						[$mdgriffith$elm_ui$Internal$Style$classes.dS, $mdgriffith$elm_ui$Internal$Style$classes.P, $mdgriffith$elm_ui$Internal$Style$classes.cg, $mdgriffith$elm_ui$Internal$Style$classes.bj])))
			]),
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				A2(
					...
					' ',
					_List_fromArray(
						[$mdgriffith$elm_ui$Internal$Style$classes.dS, $mdgriffith$elm_ui$Internal$Style$classes.P, $mdgriffith$elm_ui$Internal$Style$classes.ch, $mdgriffith$elm_ui$Internal$Style$classes.bK])))
			]),
		_List_fromArray(
			[
				...
				return $mdgriffith$elm_ui$Internal$Model$Unstyled(
					A5(
						...
						$mdgriffith$elm_ui$Internal$Model$Keyed(
							A3($mdgriffith$elm_ui$Internal$Model$addKeyedChildren, 'nearby-element-pls', keyed, rendered.ap)),
				...
				return $mdgriffith$elm_ui$Internal$Model$Unstyled(
					A5(
						...
						$mdgriffith$elm_ui$Internal$Model$Unkeyed(
							A2($mdgriffith$elm_ui$Internal$Model$addChildren, unkeyed, rendered.ap)),
						$mdgriffith$elm_ui$Internal$Model$NoStyleSheet));
			} else {
				var allStyles = newStyles;
				return $mdgriffith$elm_ui$Internal$Model$Styled(
						...
						switch (location) {
							case 0:
								return A2(
									...
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.aI, $mdgriffith$elm_ui$Internal$Style$classes.fp, $mdgriffith$elm_ui$Internal$Style$classes.dG]));
							case 1:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.aI, $mdgriffith$elm_ui$Internal$Style$classes.fp, $mdgriffith$elm_ui$Internal$Style$classes.dY]));
							case 2:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.aI, $mdgriffith$elm_ui$Internal$Style$classes.fp, $mdgriffith$elm_ui$Internal$Style$classes.e$]));
							case 3:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.aI, $mdgriffith$elm_ui$Internal$Style$classes.fp, $mdgriffith$elm_ui$Internal$Style$classes.eZ]));
							case 4:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.aI, $mdgriffith$elm_ui$Internal$Style$classes.fp, $mdgriffith$elm_ui$Internal$Style$classes.eD]));
							default:
								return A2(
									$elm$core$String$join,
									' ',
									_List_fromArray(
										[$mdgriffith$elm_ui$Internal$Style$classes.aI, $mdgriffith$elm_ui$Internal$Style$classes.fp, $mdgriffith$elm_ui$Internal$Style$classes.dX]));
						}
					}())
				]),
			_List_fromArray(
...
var $mdgriffith$elm_ui$Internal$Model$alignXName = function (align) {
	switch (align) {
		case 0:
			return $mdgriffith$elm_ui$Internal$Style$classes.bB + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.ck);
		case 2:
			return $mdgriffith$elm_ui$Internal$Style$classes.bB + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.cl);
		default:
			return $mdgriffith$elm_ui$Internal$Style$classes.bB + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.dJ);
	}
};
var $mdgriffith$elm_ui$Internal$Model$alignYName = function (align) {
	switch (align) {
		case 0:
			return $mdgriffith$elm_ui$Internal$Style$classes.bC + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.dP);
		case 2:
			return $mdgriffith$elm_ui$Internal$Style$classes.bC + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.dI);
		default:
			return $mdgriffith$elm_ui$Internal$Style$classes.bC + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.dK);
	}
};
			...
			return (portion === 1) ? _Utils_Tuple3(
				...
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Internal$Style$classes.dS + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.fh + (' > ' + $mdgriffith$elm_ui$Internal$Style$dot(
								...
								case 2:
									...
									if (portion === 1) {
										...
										var $temp$classes = classes + (' ' + ($mdgriffith$elm_ui$Internal$Style$classes.cI + (' height-fill-' + $elm$core$String$fromInt(portion)))),
											...
											A3(
												$mdgriffith$elm_ui$Internal$Model$Single,
												$mdgriffith$elm_ui$Internal$Style$classes.dS + ('.' + ($mdgriffith$elm_ui$Internal$Style$classes.ef + (' > ' + $mdgriffith$elm_ui$Internal$Style$dot(
													'height-fill-' + $elm$core$String$fromInt(portion))))),
												'flex-grow',
												$elm$core$String$fromInt(portion * 100000)),
											styles),
...
var $mdgriffith$elm_ui$Internal$Model$focusDefaultStyle = {
	...
	fo: $elm$core$Maybe$Just(
		{
			aC: 3,
			ee: A4($mdgriffith$elm_ui$Internal$Model$Rgba, 155 / 255, 203 / 255, 1, 1),
			c: _Utils_Tuple2(0, 0),
			dh: 3
		})
};
var $mdgriffith$elm_ui$Internal$Model$optionsToRecord = function (options) {
	...
	return andFinally(
		A3(
			$elm$core$List$foldr,
			combine,
			{es: $elm$core$Maybe$Nothing, ez: $elm$core$Maybe$Nothing, eT: $elm$core$Maybe$Nothing},
			options));
};
			...
			A2(
				...
				$mdgriffith$elm_ui$Internal$Model$htmlClass(
					A2(
						...
						' ',
						_List_fromArray(
							[$mdgriffith$elm_ui$Internal$Style$classes.ff, $mdgriffith$elm_ui$Internal$Style$classes.dS, $mdgriffith$elm_ui$Internal$Style$classes.fp]))),
...
var $mdgriffith$elm_ui$Element$row = F2(
	function (attrs, children) {
		return A4(
			...
			A2(
				$elm$core$List$cons,
				$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.aS + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.aa)),
				A2(
					$elm$core$List$cons,
					$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$shrink),
					A2(
...
var $author$project$Guide$appendSlash = function (url) {
	return A2($elm$core$String$endsWith, '/', url) ? url : (url + '/');
};
...
var $author$project$Guide$Text$Body = 3;
var $author$project$Guide$Document$ImageLoaded = function (a) {
	return {$: 1, a: a};
};
var $author$project$Guide$Text$Prose = 0;
var $author$project$Guide$Document$TopLevel = 0;
var $author$project$Guide$Document$Updated = function (a) {
	return {$: 0, a: a};
};
...
var $mdgriffith$elm_ui$Element$column = F2(
	function (attrs, children) {
		return A4(
			...
			A2(
				$elm$core$List$cons,
				$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.eg + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.aS)),
				A2(
					$elm$core$List$cons,
					$mdgriffith$elm_ui$Element$height($mdgriffith$elm_ui$Element$shrink),
					A2(
...
var $author$project$Guide$Text$bodyFontFamily = $mdgriffith$elm_ui$Element$Font$family(
	_List_fromArray(
		[
...
var $author$project$Guide$Text$codeFontFamily = $mdgriffith$elm_ui$Element$Font$family(
	_List_fromArray(
		[
			$mdgriffith$elm_ui$Element$Font$typeface('Source Code Pro'),
			$mdgriffith$elm_ui$Element$Font$monospace
		]));
var $author$project$Guide$Text$headingFontFamily = $mdgriffith$elm_ui$Element$Font$family(
	_List_fromArray(
		[
			$mdgriffith$elm_ui$Element$Font$typeface('Source Sans Pro'),
			$mdgriffith$elm_ui$Element$Font$sansSerif
		]));
var $author$project$Guide$Text$fontFamily = function (location) {
	switch (location) {
		case 0:
			return $author$project$Guide$Text$headingFontFamily;
		case 1:
			return $author$project$Guide$Text$headingFontFamily;
		case 2:
			return $author$project$Guide$Text$headingFontFamily;
		case 3:
			return $author$project$Guide$Text$bodyFontFamily;
		case 4:
			return $author$project$Guide$Text$codeFontFamily;
		case 5:
			return $author$project$Guide$Text$headingFontFamily;
		default:
			return $author$project$Guide$Text$bodyFontFamily;
...
var $author$project$Guide$Text$fontSize = F3(
	function (screenClass, location, kind) {
		if (screenClass === 1) {
			var _v1 = _Utils_Tuple2(location, kind);
			switch (_v1.a) {
				case 0:
					if (!_v1.b) {
						var _v2 = _v1.a;
			...
			var _v21 = _Utils_Tuple2(location, kind);
			switch (_v21.a) {
				case 0:
					if (!_v21.b) {
						var _v22 = _v21.a;
...
var $author$project$Guide$Document$spacer = function (height) {
	return A2(
		$mdgriffith$elm_ui$Element$el,
		_List_fromArray(
			[
		...
		return A2(
			...
			function (chunk) {
				switch (chunk.$) {
					...
					case 3:
						var id = chunk.a;
						return _Utils_eq(id, givenId) ? A2($author$project$Guide$Document$CustomBlock, id, newWidget) : chunk;
					case 4:
						return chunk;
					case 5:
						return chunk;
					default:
						var bullets = chunk.a;
						return $author$project$Guide$Document$Bullets(
							A2(
								$elm$core$List$map,
...
var $author$project$Guide$Document$InternalWidgetUpdated = F2(
	function (a, b) {
		return {$: 0, a: a, b: b};
	});
var $author$project$Guide$Document$WithinBulletedList = 1;
...
var $author$project$Guide$Document$bulletIcon = F2(
	function (_v0, level) {
		var screenClass = _v0.N;
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					{cp: 0, cO: leftPadding, db: rightPadding, ds: 0})
				]),
			function () {
				var bodyFontSize = A3($author$project$Guide$Text$fontSize, screenClass, 3, 0);
					...
					A2(
						...
						_List_fromArray(
							[
								...
								$elm$core$String$fromInt(bodyFontSize))
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										...
										$elm$core$String$fromFloat(bodyFontSize - height)),
...
var $author$project$Guide$Document$minSpacingAbove = function (chunk) {
	switch (chunk.$) {
		case 0:
			return 24;
		case 1:
...
var $author$project$Guide$Document$minSpacingBelow = function (chunk) {
	switch (chunk.$) {
		case 0:
			return 16;
		case 1:
...
var $author$project$Guide$Document$interChunkSpacing = F3(
	function (level, first, second) {
		if (level === 1) {
			return $author$project$Guide$Document$bulletSpacing;
		} else {
			return A2(
				$elm$core$Basics$max,
				$author$project$Guide$Document$minSpacingBelow(first),
				$author$project$Guide$Document$minSpacingAbove(second));
		}
	});
...
var $author$project$Guide$Text$lineSpacing = F2(
	function (screenClass, location) {
...
var $mdgriffith$elm_ui$Element$scrollbarX = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$overflow, $mdgriffith$elm_ui$Internal$Style$classes.fk);
var $author$project$Guide$Document$codeBlockAttributes = function (_v0) {
	var screenClass = _v0.N;
	return _List_fromArray(
		[
			...
			A3($author$project$Guide$Text$fontSize, screenClass, 4, 1)),
			A2($author$project$Guide$Text$lineSpacing, screenClass, 4),
...
var $author$project$Guide$Color$comment = $author$project$Guide$Color$grey;
var $author$project$Guide$Color$keyword = A3($mdgriffith$elm_ui$Element$rgb255, 219, 125, 43);
var $author$project$Guide$Color$number = A3($mdgriffith$elm_ui$Element$rgb, 0, 0, 0.9);
var $author$project$Guide$Color$string = A3($mdgriffith$elm_ui$Element$rgb, 0, 0.5, 1);
var $author$project$Guide$Color$symbol = $author$project$Guide$Color$black;
...
var $author$project$Guide$Document$viewColoredChunk = F2(
	function (color, text) {
		return A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				...
				A2(
					...
					A2(
						...
						A2(
							...
							A2(
								$elm$core$List$cons,
								$mdgriffith$elm_ui$Internal$Model$htmlClass($mdgriffith$elm_ui$Internal$Style$classes.bf + (' ' + $mdgriffith$elm_ui$Internal$Style$classes.aa)),
								attrs))))),
			$mdgriffith$elm_ui$Internal$Model$Unkeyed(
				_List_fromArray(
					[label])));
...
var $author$project$Guide$Document$documentationLink = F4(
	function (config, moduleName, memberName, fullString) {
		return A2(
			...
			{
				bL: $mdgriffith$elm_ui$Element$text(fullString),
				aA: A4(
					$elm$url$Url$Builder$custom,
					$elm$url$Url$Builder$CrossOrigin('https://package.elm-lang.org'),
					_List_fromArray(
						[
							'packages',
							config.an,
...
var $author$project$Guide$Document$viewModule = F2(
	function (config, name) {
		return A2($elm$core$Set$member, name, config.aZ) ? A4($author$project$Guide$Document$documentationLink, config, name, $elm$core$Maybe$Nothing, name) : A2($author$project$Guide$Document$viewColoredChunk, $author$project$Guide$Color$black, name);
	});
var $author$project$Guide$Document$viewModuleMember = F3(
	function (config, _v0, fullString) {
		var moduleName = _v0.eU;
		var memberName = _v0.eR;
		return A2($elm$core$Set$member, moduleName, config.aZ) ? A4(
			$author$project$Guide$Document$documentationLink,
			config,
			moduleName,
			$elm$core$Maybe$Just(memberName),
			fullString) : A2($author$project$Guide$Document$viewColoredChunk, $author$project$Guide$Color$black, fullString);
	});
var $author$project$Guide$Color$white = A3($mdgriffith$elm_ui$Element$rgb255, 255, 255, 255);
var $author$project$Guide$Document$viewCodeChunk = F2(
	function (config, chunk) {
		switch (chunk.a.$) {
			case 0:
				var _v1 = chunk.a;
				var string = chunk.b;
				return A2($author$project$Guide$Document$viewColoredChunk, $author$project$Guide$Color$comment, string);
			case 1:
				var _v2 = chunk.a;
				var string = chunk.b;
				return A2($author$project$Guide$Document$viewColoredChunk, $author$project$Guide$Color$string, string);
			case 2:
				var _v3 = chunk.a;
				var string = chunk.b;
				return A2($author$project$Guide$Document$viewColoredChunk, $author$project$Guide$Color$number, string);
			case 3:
				var _v4 = chunk.a;
				var string = chunk.b;
				return A2($author$project$Guide$Document$viewColoredChunk, $author$project$Guide$Color$string, string);
			case 4:
				var _v5 = chunk.a;
				var string = chunk.b;
				return A2($author$project$Guide$Document$viewColoredChunk, $author$project$Guide$Color$keyword, string);
			case 8:
				var _v6 = chunk.a;
				var name = chunk.b;
				return A2($author$project$Guide$Document$viewModule, config, name);
			case 9:
				var moduleMember = chunk.a.a;
				var string = chunk.b;
				return A3($author$project$Guide$Document$viewModuleMember, config, moduleMember, string);
			case 7:
				var _v7 = chunk.a;
				var string = chunk.b;
				return A2($author$project$Guide$Document$viewColoredChunk, $author$project$Guide$Color$black, string);
			case 5:
				var _v8 = chunk.a;
				var string = chunk.b;
				return A2($author$project$Guide$Document$viewColoredChunk, $author$project$Guide$Color$symbol, string);
			default:
				var _v9 = chunk.a;
				var string = chunk.b;
				return A2($author$project$Guide$Document$viewColoredChunk, $author$project$Guide$Color$white, string);
		}
	});
var $author$project$Guide$Document$viewCodeBlockLine = F2(
		...
		if (!chunks.b) {
			...
			if ((chunks.a.a.$ === 6) && (!chunks.b.b)) {
				...
				return A2(
					...
					A2(
						$elm$core$List$map,
						$author$project$Guide$Document$viewCodeChunk(config),
						chunks));
			}
		}
	});
var $author$project$Guide$Document$viewElmCodeBlock = F2(
	function (config, syntaxChunks) {
		return A2(
			$mdgriffith$elm_ui$Element$column,
			$author$project$Guide$Document$codeBlockAttributes(config),
			A2(
				$elm$core$List$map,
				$author$project$Guide$Document$viewCodeBlockLine(config),
				syntaxChunks));
	});
...
var $mdgriffith$elm_ui$Element$Font$bold = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$fontWeight, $mdgriffith$elm_ui$Internal$Style$classes.d$);
var $author$project$Guide$Color$inlineCodeBackground = $author$project$Guide$Color$codeBlockBackground;
...
var $author$project$Guide$Document$InternalImageLoaded = function (a) {
	return {$: 1, a: a};
};
...
var $author$project$Guide$Document$renderImage = function (_v0) {
	var url = _v0.aA;
			...
			_List_fromArray(
				[
					...
					$elm$json$Json$Decode$succeed(
						$author$project$Guide$Document$InternalImageLoaded(url)))
				]),
			_List_Nil));
};
var $author$project$Guide$Document$renderTextFragment = F3(
	function (config, textLocation, fragment) {
		switch (fragment.$) {
			case 0:
			...
			case 2:
				...
				return A2(
					...
					$mdgriffith$elm_ui$Element$text(string));
			case 4:
				var url = fragment.a.aA;
				var displayed = fragment.a.bF;
				var _v1 = function () {
					switch (displayed.$) {
						case 0:
							...
							return _Utils_Tuple2(
								A2(
									...
									A2(
										$elm$core$List$cons,
										$mdgriffith$elm_ui$Element$Font$size(
											A3($author$project$Guide$Text$fontSize, config.N, textLocation, 1)),
			...
			case 3:
				...
				var codeFontSize = A3($author$project$Guide$Text$fontSize, config.N, textLocation, 1);
				return A2(
					$mdgriffith$elm_ui$Element$row,
					A2(
						$elm$core$List$cons,
						...
						A2(
							$elm$core$List$cons,
							$mdgriffith$elm_ui$Element$Font$size(codeFontSize),
							$author$project$Guide$Document$inlineCodeBackgroundAttributes)),
					A2(
						$elm$core$List$map,
						$author$project$Guide$Document$inlineCodeElement(codeFontSize),
						chunks));
			default:
...
var $author$project$Guide$Document$renderText = F3(
	function (config, textLocation, fragments) {
		return A2(
			$elm$core$List$map,
			A2($author$project$Guide$Document$renderTextFragment, config, textLocation),
			fragments);
	});
var $author$project$Guide$Document$viewParagraph = F2(
	function (config, textFragments) {
		return A2(
			$mdgriffith$elm_ui$Element$paragraph,
			_List_fromArray(
				[
					A2($author$project$Guide$Text$lineSpacing, config.N, 3)
				]),
			A3($author$project$Guide$Document$renderText, config, 3, textFragments));
	});
var $author$project$Guide$Document$viewPlainCodeBlock = F2(
...
var $author$project$Guide$Text$Section = 1;
	...
	while (true) {
		switch (textFragment.$) {
			...
			case 2:
				...
				return string;
			case 4:
				var displayed = textFragment.a.bF;
			...
			case 3:
				...
				return $elm$core$String$concat(
					A2($elm$core$List$map, $author$project$Guide$Document$inlineCodeChunkToString, chunks));
			default:
				var description = textFragment.a.cz;
				return description;
		}
	}
};
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$author$project$Guide$Text$fontFamily(1),
					$mdgriffith$elm_ui$Element$Font$size(
					A3($author$project$Guide$Text$fontSize, config.N, 1, 0)),
					A2($author$project$Guide$Text$lineSpacing, config.N, 1),
					$mdgriffith$elm_ui$Element$htmlAttribute(
					$elm$html$Html$Attributes$id(
						$author$project$Guide$Document$toId(textFragments)))
				]),
			A3($author$project$Guide$Document$renderText, config, 1, textFragments));
	});
var $author$project$Guide$Text$Subsection = 2;
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$author$project$Guide$Text$fontFamily(2),
					$mdgriffith$elm_ui$Element$Font$size(
					A3($author$project$Guide$Text$fontSize, config.N, 2, 0)),
					A2($author$project$Guide$Text$lineSpacing, config.N, 2),
					$mdgriffith$elm_ui$Element$htmlAttribute(
					$elm$html$Html$Attributes$id(
						$author$project$Guide$Document$toId(textFragments)))
				]),
			A3($author$project$Guide$Document$renderText, config, 2, textFragments));
	});
var $author$project$Guide$Document$widthFill = $mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill);
var $author$project$Guide$Document$bulletedItem = F3(
	function (config, level, chunks) {
		return A2(
			$mdgriffith$elm_ui$Element$row,
			_List_fromArray(
			...
			_List_fromArray(
				[
					...
					A2($author$project$Guide$Document$bulletIcon, config, level)),
					A3($author$project$Guide$Document$viewChunks, config, 1, chunks)
				]));
	});
var $author$project$Guide$Document$viewBullets = F3(
	function (config, level, bullets) {
		return A2(
			$mdgriffith$elm_ui$Element$column,
			_List_fromArray(
				[
			...
			A2(
				$elm$core$List$map,
				A2($author$project$Guide$Document$bulletedItem, config, level),
				bullets));
	});
var $author$project$Guide$Document$viewChunk = F3(
	function (config, level, chunk) {
		switch (chunk.$) {
			case 0:
				var textFragments = chunk.a;
				return A2($author$project$Guide$Document$viewSection, config, textFragments);
			case 1:
				var textFragments = chunk.a;
				return A2($author$project$Guide$Document$viewSubsection, config, textFragments);
			case 2:
				var textFragments = chunk.a;
				return A2($author$project$Guide$Document$viewParagraph, config, textFragments);
			case 3:
				var id = chunk.a;
				var widget = chunk.b;
				return A2(
					...
					function (newWidget) {
						return A2($author$project$Guide$Document$InternalWidgetUpdated, id, newWidget);
					},
					widget);
			case 4:
				var contents = chunk.a;
				return A2($author$project$Guide$Document$viewPlainCodeBlock, config, contents);
			case 5:
				var lines = chunk.a;
				return A2($author$project$Guide$Document$viewElmCodeBlock, config, lines);
			default:
				var bullets = chunk.a;
				return A3($author$project$Guide$Document$viewBullets, config, level, bullets);
		}
	});
var $author$project$Guide$Document$viewChunks = F3(
	function (config, level, chunks) {
		return A2(
			$mdgriffith$elm_ui$Element$textColumn,
			_List_fromArray(
				[$author$project$Guide$Document$widthFill]),
			A4($author$project$Guide$Document$viewChunksHelp, config, level, chunks, _List_Nil));
	});
var $author$project$Guide$Document$viewChunksHelp = F4(
	function (config, level, chunks, accumulated) {
		viewChunksHelp:
		while (true) {
			if (!chunks.b) {
				return $elm$core$List$reverse(accumulated);
			} else {
				if (!chunks.b.b) {
					var last = chunks.a;
					return $elm$core$List$reverse(
						A2(
							$elm$core$List$cons,
							A3($author$project$Guide$Document$viewChunk, config, level, last),
							accumulated));
				} else {
					var chunk = chunks.a;
					var _v1 = chunks.b;
					...
					var $temp$config = config,
						$temp$level = level,
						$temp$chunks = A2($elm$core$List$cons, next, remaining),
						$temp$accumulated = A2(
						$elm$core$List$cons,
						$author$project$Guide$Document$spacer(
							A3($author$project$Guide$Document$interChunkSpacing, level, chunk, next)),
						A2(
							$elm$core$List$cons,
							A3($author$project$Guide$Document$viewChunk, config, level, chunk),
							accumulated));
					config = $temp$config;
					level = $temp$level;
					chunks = $temp$chunks;
					accumulated = $temp$accumulated;
					continue viewChunksHelp;
				}
			}
		}
	});
var $author$project$Guide$Text$Title = 0;
var $author$project$BoundingBox2d$extrema = function (_v0) {
	var boundingBoxExtrema = _v0;
	return boundingBoxExtrema;
};
var $author$project$Quantity$Quantity = $elm$core$Basics$identity;
var $author$project$Quantity$minus = F2(
	function (_v0, _v1) {
		var y = _v0;
		var x = _v1;
		return x - y;
...
var $author$project$Pixels$inPixels = function (_v0) {
	var numPixels = _v0;
	return numPixels;
};
var $author$project$Geometry$Svg$toString = function (pixels) {
	return $elm$core$String$fromFloat(
		$author$project$Pixels$inPixels(pixels));
};
var $elm$svg$Svg$Attributes$x = _VirtualDom_attribute('x');
var $elm$svg$Svg$Attributes$y = _VirtualDom_attribute('y');
var $author$project$Geometry$Svg$boundingBox2d = F2(
	function (attributes, boundingBox) {
		var _v0 = $author$project$BoundingBox2d$extrema(boundingBox);
		var minX = _v0.p;
		var minY = _v0.q;
		var maxX = _v0.n;
		var maxY = _v0.o;
		var width = $elm$svg$Svg$Attributes$width(
			$author$project$Geometry$Svg$toString(
				A2($author$project$Quantity$minus, minX, maxX)));
		var x = $elm$svg$Svg$Attributes$x(
			$author$project$Geometry$Svg$toString(minX));
		var height = $elm$svg$Svg$Attributes$height(
			$author$project$Geometry$Svg$toString(
				A2($author$project$Quantity$minus, minY, maxY)));
		var y = $elm$svg$Svg$Attributes$y(
			$author$project$Geometry$Svg$toString(minY));
		return A2(
			$elm$svg$Svg$rect,
			A2(
				$elm$core$List$cons,
...
var $author$project$Geometry$Types$BoundingBox2d = $elm$core$Basics$identity;
var $author$project$Quantity$lessThanOrEqualTo = F2(
	function (_v0, _v1) {
		var y = _v0;
		var x = _v1;
		return _Utils_cmp(x, y) < 1;
	});
var $author$project$Quantity$max = F2(
	function (_v0, _v1) {
		var x = _v0;
		var y = _v1;
		return A2($elm$core$Basics$max, x, y);
	});
var $author$project$Quantity$min = F2(
	function (_v0, _v1) {
		var x = _v0;
		var y = _v1;
		return A2($elm$core$Basics$min, x, y);
	});
var $author$project$BoundingBox2d$fromExtrema = function (given) {
	return (A2($author$project$Quantity$lessThanOrEqualTo, given.n, given.p) && A2($author$project$Quantity$lessThanOrEqualTo, given.o, given.q)) ? given : {
		n: A2($author$project$Quantity$max, given.p, given.n),
		o: A2($author$project$Quantity$max, given.q, given.o),
		p: A2($author$project$Quantity$min, given.p, given.n),
		q: A2($author$project$Quantity$min, given.q, given.o)
	};
};
var $author$project$Pixels$pixels = function (numPixels) {
	return numPixels;
};
var $author$project$Guide$Document$hamburgerIcon = function () {
	var width = 20;
	var height = A3($author$project$Guide$Text$fontSize, 0, 0, 0);
	var rectangle = F2(
		function (bottomY, topY) {
			return A2(
				$author$project$Geometry$Svg$boundingBox2d,
				_List_Nil,
				$author$project$BoundingBox2d$fromExtrema(
					{
						n: $author$project$Pixels$pixels(18),
						o: $author$project$Pixels$pixels(height - bottomY),
						p: $author$project$Pixels$pixels(2),
						q: $author$project$Pixels$pixels(height - topY)
					}));
		});
	return $mdgriffith$elm_ui$Element$html(
		A2(
					...
					[
						...
						_List_fromArray(
							[
								...
								$author$project$Guide$Text$fontFamily(0),
								$mdgriffith$elm_ui$Element$Font$size(
								A3($author$project$Guide$Text$fontSize, config.N, 0, 0)),
								A2($author$project$Guide$Text$lineSpacing, config.N, 0),
								$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$fill)
							]),
						A3($author$project$Guide$Document$renderText, config, 0, textFragments)),
						function () {
						var _v1 = config.N;
						if (!_v1) {
							return A2(
								...
								{bL: $author$project$Guide$Document$hamburgerIcon, aA: config.fg});
						} else {
				...
				if (!_v0.$) {
					...
					return A2(
						...
						_List_fromArray(
							[
								titleElement,
								$author$project$Guide$Document$spacer(8),
								A2(
								$mdgriffith$elm_ui$Element$paragraph,
								_List_fromArray(
									[
										...
										$mdgriffith$elm_ui$Element$Font$italic,
										$mdgriffith$elm_ui$Element$Font$size(
										A3($author$project$Guide$Text$fontSize, config.N, 3, 0))
									]),
								_List_fromArray(
									[
...
var $author$project$Guide$Document$view = F3(
	function (config, givenAttributes, _v0) {
		var document = _v0;
		var toMsg = function (internalMessage) {
			if (!internalMessage.$) {
				var id = internalMessage.a;
				var widget = internalMessage.b;
				return $author$project$Guide$Document$Updated(
					_Utils_update(
						document,
						{
							ba: A3($author$project$Guide$Document$updateWidget, id, widget, document.ba)
						}));
			} else {
				var url = internalMessage.a;
				return $author$project$Guide$Document$ImageLoaded(url);
			}
		};
		var mainContent = $mdgriffith$elm_ui$Element$Region$mainContent;
		var fontSize = $mdgriffith$elm_ui$Element$Font$size(
			A3($author$project$Guide$Text$fontSize, config.N, 3, 0));
		var fontFamily = $author$project$Guide$Text$fontFamily(3);
		var bottomSpacer = A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				[
		...
		return A2(
			...
			A2(
				...
				A2(
					$elm$core$List$cons,
					fontSize,
					A2($elm$core$List$cons, mainContent, givenAttributes))),
			_List_fromArray(
				[
					A2(
					$mdgriffith$elm_ui$Element$map,
					toMsg,
					A2($author$project$Guide$Document$viewTitle, config, document.dr)),
					$author$project$Guide$Document$spacer(20),
					A2(
					$mdgriffith$elm_ui$Element$map,
					toMsg,
					A3($author$project$Guide$Document$viewChunks, config, 0, document.ba)),
					bottomSpacer
				]));
	});
var $author$project$Guide$viewDocument = F4(
	function (model, attributes, loadedDocument, lastModified) {
		var documentConfig = {
			an: model.an,
			aH: lastModified,
			aZ: model.aZ,
			V: model.V,
			fg: $author$project$Guide$appendSlash(
				A2($elm$url$Url$Builder$absolute, model.aN, _List_Nil)),
			N: model.N
		};
		return A2(
			$mdgriffith$elm_ui$Element$map,
			$author$project$Guide$DocumentMsg,
			A3(
...
var $author$project$Guide$Text$NavBody = 6;
var $author$project$Guide$Text$NavTitle = 5;
var $mdgriffith$elm_ui$Element$clipY = A2($mdgriffith$elm_ui$Internal$Model$Class, $mdgriffith$elm_ui$Internal$Flag$overflow, $mdgriffith$elm_ui$Internal$Style$classes.ec);
			...
			_List_fromArray(
				[
					...
					$mdgriffith$elm_ui$Element$px(
						A3($author$project$Guide$Text$fontSize, model.N, 6, 0)))
				]),
			properties);
	});
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				model,
				{cz: 'GitHub logo', dj: 'images/github.svg'}),
				A2(
				$mdgriffith$elm_ui$Element$link,
				_List_Nil,
				{
					bL: $mdgriffith$elm_ui$Element$text('Source code'),
					aA: A3(
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				$author$project$Guide$navIcon,
				model,
				{cz: 'Elm logo', dj: 'images/elm.svg'}),
				A2(
				$mdgriffith$elm_ui$Element$link,
				_List_Nil,
				{
					bL: $mdgriffith$elm_ui$Element$text('API documentation'),
					aA: A3(
						$elm$url$Url$Builder$crossOrigin,
						'https://package.elm-lang.org',
						_List_fromArray(
							['packages', model.an, model.V, 'latest']),
						_List_Nil)
				})
			]));
};
...
var $author$project$Guide$toPageLink = F3(
	function (rootPath, currentPage, page) {
		var attributes = _Utils_eq(
			currentPage,
			$elm$core$Maybe$Just(page)) ? _List_fromArray(
			[$mdgriffith$elm_ui$Element$Font$bold]) : _List_Nil;
		return A2(
			$mdgriffith$elm_ui$Element$link,
			attributes,
			{
				bL: $mdgriffith$elm_ui$Element$text(
					$author$project$Guide$Page$title(page)),
				aA: A3($author$project$Guide$Page$displayedUrl, rootPath, page, $elm$core$Maybe$Nothing)
			});
	});
var $author$project$Guide$viewNav = F2(
	function (model, currentPage) {
		var titleElement = A2(
			...
			_List_fromArray(
				[
					...
					$mdgriffith$elm_ui$Element$Font$size(
					A3($author$project$Guide$Text$fontSize, model.N, 5, 0))
				]),
			_List_fromArray(
				[
		...
		var navElement = A2(
			...
			_List_fromArray(
				[
					...
					$author$project$Guide$Text$fontFamily(3),
					$mdgriffith$elm_ui$Element$Font$color($author$project$Guide$Color$linkText),
					$mdgriffith$elm_ui$Element$Font$size(
					A3($author$project$Guide$Text$fontSize, model.N, 6, 0)),
					$mdgriffith$elm_ui$Element$Font$regular,
					$mdgriffith$elm_ui$Element$spacing(12),
					$mdgriffith$elm_ui$Element$padding(navPadding)
				]),
			$elm$core$List$concat(
				_List_fromArray(
					[
						...
						A2(
						$elm$core$List$map,
						A2($author$project$Guide$toPageLink, model.aN, currentPage),
						model.a7),
						_List_fromArray(
						[$author$project$Guide$horizontalDivider]),
						_List_fromArray(
		...
		var elementWidth = function () {
			var _v0 = model.N;
			if (_v0 === 1) {
				return $mdgriffith$elm_ui$Element$px($author$project$Guide$navWidth);
			} else {
		...
		return A2(
			...
			_List_fromArray(
				[
					$author$project$Guide$heightFill,
					$mdgriffith$elm_ui$Element$width(elementWidth),
				...
				if (_v0 === 1) {
					var documentElement = function () {
						...
						switch (_v2.$) {
							...
							case 1:
								return $mdgriffith$elm_ui$Element$none;
							case 3:
								var document = _v2.a.bh;
								var lastModified = _v2.a.aH;
								return A4(
									$author$project$Guide$viewDocument,
									model,
									_List_fromArray(
										[$author$project$Guide$widthFill, $author$project$Guide$heightFill]),
									document,
									lastModified);
							default:
								var message = _v2.a;
					...
					var displayedPage = function () {
						...
						switch (_v1.$) {
							...
							case 0:
								return $elm$core$Maybe$Just(model.bt);
							case 1:
								return $elm$core$Maybe$Nothing;
							default:
								return $elm$core$Maybe$Nothing;
					...
					return A2(
						...
						_List_fromArray(
							[
								$author$project$Guide$widthFill,
								$author$project$Guide$heightFill,
								$mdgriffith$elm_ui$Element$inFront(navLayer)
							]),
						mainLayer);
				} else {
					return A2(
						...
						function () {
							...
							switch (_v3.$) {
								...
								case 1:
									return $mdgriffith$elm_ui$Element$none;
								case 3:
									var document = _v3.a.bh;
									var lastModified = _v3.a.aH;
									return A4(
										$author$project$Guide$viewDocument,
										model,
										_List_fromArray(
											[
												...
												$mdgriffith$elm_ui$Element$width(
												A2($mdgriffith$elm_ui$Element$maximum, 10000, $mdgriffith$elm_ui$Element$fill))
											]),
										document,
										lastModified);
								default:
...
var $author$project$Guide$Page$with = function (given) {
	return $author$project$Guide$Page$Page(
		{
			dq: given.dq,
			a6: $elm$core$Dict$fromList(given.a6)
		});
};
var $author$project$Guide$program = function (_v0) {
	var author = _v0.an;
	var packageName = _v0.V;
	var branch = _v0.d6;
	var pages = _v0.e4;
	var widgets = _v0.a6;
	var toPage = function (title) {
		return $author$project$Guide$Page$with(
			{dq: title, a6: widgets});
	};
	var readmeUrl = A3(
		$elm$url$Url$Builder$crossOrigin,
	...
	var allPages = A2(
		$elm$core$List$cons,
		readmePage,
		A2($elm$core$List$map, toPage, pages));
	return $elm$browser$Browser$application(
		{
			eF: A5($author$project$Guide$init, author, packageName, widgets, readmePage, allPages),
			e0: $author$project$Guide$UrlChanged,
			e1: $author$project$Guide$UrlRequested,
			fF: $elm$core$Basics$always($elm$core$Platform$Sub$none),
			fZ: $author$project$Guide$update,
			f$: $author$project$Guide$view
		});
};
var $author$project$Main$main = $author$project$Guide$program(
	{
		an: 'ianmackenzie',
		d6: 'coordinate-systems',
		V: 'elm-geometry',
		e4: _List_fromArray(
			['Units and coordinate systems', 'Transformations']),
		a6: _List_Nil
	});
